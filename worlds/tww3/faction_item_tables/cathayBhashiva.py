...
units: dict[int, itemData] = {
    ...
    74003: itemData(IC.useful, 1, 'wh3_cp1_cth_inf_tiger_warrior_dual_axes', itemType.unit, 2, 'Progressive cth_bhashiva_inf', 'Cathay Bhashiva Unit: Tiger Warriors'),
    74004: itemData(IC.useful, 1, 'wh3_cp1_cth_inf_tiger_warrior_stalkers', itemType.unit, 3, 'Progressive cth_bhashiva_inf', 'Cathay Bhashiva Unit: Tiger Warrior Stalkers'),
...
buildings: dict[int, itemData] = {
    ...
    74401: itemData(IC.useful, 1, 'wh3_main_cth_bhashiva_settlement_major_2', itemType.building, 1, 'Progressive cth_bhashiva_settlement_major', 'Cathay Bhashiva Building: Village (Major)'),
    74402: itemData(IC.useful, 1, 'wh3_main_cth_bhashiva_settlement_major_3', itemType.building, 2, 'Progressive cth_bhashiva_settlement_major', 'Cathay Bhashiva Building: Town (Major)'),
    74403: itemData(IC.useful, 1, 'wh3_main_cth_bhashiva_settlement_major_4', itemType.building, 3, 'Progressive cth_bhashiva_settlement_major', 'Cathay Bhashiva Building: City (Major)'),
    74404: itemData(IC.useful, 1, 'wh3_main_cth_bhashiva_settlement_major_5', itemType.building, 4, 'Progressive cth_bhashiva_settlement_major', 'Cathay Bhashiva Building: Province Capital (Major)'),
    74405: itemData(IC.useful, 1, 'wh3_main_cth_bhashiva_settlement_minor_1', itemType.building, 0, 'Progressive cth_bhashiva_settlement_minor', 'Cathay Bhashiva Building: Hamlet (Minor)'),
    74406: itemData(IC.useful, 1, 'wh3_main_cth_bhashiva_settlement_minor_2', itemType.building, 1, 'Progressive cth_bhashiva_settlement_minor', 'Cathay Bhashiva Building: Village (Minor)'),
    74407: itemData(IC.useful, 1, 'wh3_main_cth_bhashiva_settlement_minor_3', itemType.building, 2, 'Progressive cth_bhashiva_settlement_minor', 'Cathay Bhashiva Building: Town (Minor)'),
