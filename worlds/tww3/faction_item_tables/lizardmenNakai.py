...
buildings: dict[int, itemData] = {
    ...
    68428: itemData(IC.useful, 1, 'wh2_dlc13_horde_lizardmen_support_rrank_1', itemType.building, 0, 'Progressive lzd_horde_rank', 'Lzd Nakai Horde Building: Training Hall'),
    68429: itemData(IC.useful, 1, 'wh2_dlc13_horde_lizardmen_support_rrank_2', itemType.building, 1, 'Progressive lzd_horde_rank', 'Lzd Nakai Horde Building: Sacred Arena'),
...
progBuildings: dict[int, itemData] = {
    ...
    69310: itemData(IC.useful, 2, 'Progressive lzd_horde_rank', itemType.building, 2, None, 'Progressive Lzd Nakai Horde Building: Nexus'),
