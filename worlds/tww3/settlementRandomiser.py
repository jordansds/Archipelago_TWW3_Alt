...
factionDict: dict[int, factionData] = {
    ...
    1: factionData("wh3_main_kho_exiles_of_khorne", True, True, "daemons"),
    2: factionData("wh3_dlc26_kho_skulltaker", True, True, "daemons"),
    3: factionData("wh3_dlc26_kho_arbaal", True, True, "daemons"),
    4: factionData("wh3_main_nur_poxmakers_of_nurgle", True, True, "daemons"),
    5: factionData("wh3_dlc25_nur_tamurkhan", True, True, "daemons"),
    6: factionData("wh3_dlc25_nur_epidemius", True, True, "daemons"),
    7: factionData("wh3_main_sla_seducers_of_slaanesh", True, True, "daemons"),
    8: factionData("wh3_dlc27_sla_the_tormentors", True, False, "daemons"),
    9: factionData("wh3_dlc27_sla_masque_of_slaanesh", True, True, "daemons"),
    10: factionData("wh3_main_tze_oracles_of_tzeentch", True, True, "daemons"),
    11: factionData("wh3_dlc24_tze_the_deceivers", True, False, "daemons"),
    12: factionData("wh3_main_ksl_the_ice_court", True, True, "kislev"),
    13: factionData("wh3_main_ksl_the_great_orthodoxy", True, True, "kislev"),
    14: factionData("wh3_main_ksl_ursun_revivalists", True, False, "kislev"),
    15: factionData("wh3_dlc24_ksl_daughters_of_the_forest", True, True, "kislev"),
    16: factionData("wh3_main_ogr_goldtooth", True, True, "ogres"),
    17: factionData("wh3_main_ogr_disciples_of_the_maw", True, True, "ogres"),
    18: factionData("wh3_dlc26_ogr_golgfag", True, False, "ogres"),
    19: factionData("wh3_dlc23_chd_astragoth", True, True, "chaosDwarfs"),
    20: factionData("wh3_dlc23_chd_legion_of_azgorh", True, True, "chaosDwarfs"),
    21: factionData("wh3_dlc23_chd_zhatan", True, True, "chaosDwarfs"),
    22: factionData("wh3_main_cth_the_northern_provinces", True, True, "cathay"),
    23: factionData("wh3_main_cth_the_western_provinces", True, True, "cathay"),
    24: factionData("wh3_dlc24_cth_the_celestial_court", True, True, "cathay"),
    25: factionData("wh2_main_hef_eataine", True, True, "highElves"),
    26: factionData("wh2_main_hef_order_of_loremasters", True, True, "highElves"),
    27: factionData("wh2_main_hef_avelorn", True, True, "highElves"),
    28: factionData("wh2_main_hef_nagarythe", True, True, "highElves"),
    29: factionData("wh2_main_hef_yvresse", True, True, "highElves"),
    30: factionData("wh2_dlc15_hef_imrik", True, True, "highElves"),
    31: factionData("wh3_dlc27_hef_aislinn", True, False, "highElves"),
    32: factionData("wh2_dlc17_lzd_oxyotl", True, True, "lizardmen"),
    33: factionData("wh2_main_lzd_hexoatl", True, True, "lizardmen"),
    34: factionData("wh2_main_lzd_last_defenders", True, True, "lizardmen"),
    35: factionData("wh2_dlc12_lzd_cult_of_sotek", True, True, "lizardmen"),
    36: factionData("wh2_main_lzd_tlaqua", True, True, "lizardmen"),
    37: factionData("wh2_dlc13_lzd_spirits_of_the_jungle", True, False, "lizardmen"),
    38: factionData("wh2_main_lzd_itza", True, True, "lizardmen"),
    39: factionData("wh2_main_def_naggarond", True, True, "darkElves"),
    40: factionData("wh2_main_def_cult_of_pleasure", True, True, "darkElves"),
    41: factionData("wh2_main_def_har_ganeth", True, True, "darkElves"),
    42: factionData("wh2_dlc11_def_the_blessed_dread", True, True, "darkElves"),
    43: factionData("wh2_main_def_hag_graef", True, False, "darkElves"),
    44: factionData("wh2_twa03_def_rakarth", True, True, "darkElves"),
    45: factionData("wh2_main_skv_clan_mors", True, True, "skaven"),
    46: factionData("wh2_main_skv_clan_pestilens", True, True, "skaven"),
    47: factionData("wh2_dlc09_skv_clan_rictus", True, True, "skaven"),
    48: factionData("wh2_main_skv_clan_skryre", True, True, "skaven"),
    49: factionData("wh2_main_skv_clan_moulder", True, True, "skaven"),
    50: factionData("wh2_main_skv_clan_eshin", True, True, "skaven"),
    51: factionData("wh2_dlc09_tmb_khemri", True, True, "tombKings"),
    52: factionData("wh2_dlc09_tmb_lybaras", True, True, "tombKings"),
    53: factionData("wh2_dlc09_tmb_exiles_of_nehek", True, True, "tombKings"),
    54: factionData("wh2_dlc09_tmb_followers_of_nagash", True, True, "tombKings"),
    55: factionData("wh2_dlc11_cst_vampire_coast", True, True, "vampireCoast"),
    56: factionData("wh2_dlc11_cst_noctilus", True, True, "vampireCoast"),
    57: factionData("wh2_dlc11_cst_the_drowned", True, True, "vampireCoast"),
    58: factionData("wh2_dlc11_cst_pirates_of_sartosa", True, True, "vampireCoast"),
    59: factionData("wh_main_emp_empire", True, True, "empire"),
    60: factionData("wh2_dlc13_emp_golden_order", True, False, "empire"),
    61: factionData("wh3_main_emp_cult_of_sigmar", True, True, "empire"),
    62: factionData("wh2_dlc13_emp_the_huntmarshals_expedition", True, True, "empire"),
    63: factionData("wh_main_emp_wissenland", True, True, "empire"),
    64: factionData("wh_main_dwf_dwarfs", True, True, "dwarfs"),
    65: factionData("wh_main_dwf_karak_kadrin", True, True, "dwarfs"),
    66: factionData("wh_main_dwf_karak_izor", True, True, "dwarfs"),
    67: factionData("wh3_main_dwf_the_ancestral_throng", True, True, "dwarfs"),
    68: factionData("wh2_dlc17_dwf_thorek_ironbrow", True, True, "dwarfs"),
    69: factionData("wh3_dlc25_dwf_malakai", True, True, "dwarfs"),
    70: factionData("wh_main_grn_greenskins", True, True, "greenskins"),
    71: factionData("wh_main_grn_crooked_moon", True, True, "greenskins"),
    72: factionData("wh2_dlc15_grn_bonerattlaz", True, True, "greenskins"),
    73: factionData("wh_main_grn_orcs_of_the_bloody_hand", True, True, "greenskins"),
    74: factionData("wh2_dlc15_grn_broken_axe", True, True, "greenskins"),
    75: factionData("wh3_dlc26_grn_gorbad_ironclaw", True, True, "greenskins"),
    76: factionData("wh_main_vmp_vampire_counts", True, True, "vampireCounts"),
    77: factionData("wh2_dlc11_vmp_the_barrow_legion", True, True, "vampireCounts"),
    78: factionData("wh3_main_vmp_caravan_of_blue_roses", True, True, "vampireCounts"),
    79: factionData("wh_main_vmp_schwartzhafen", True, True, "vampireCounts"),
    80: factionData("wh_main_chs_chaos", True, False, "chaos"),
    81: factionData("wh3_dlc20_chs_kholek", True, False, "chaos"),
    82: factionData("wh3_dlc20_chs_sigvald", True, False, "chaos"),
    83: factionData("wh3_dlc20_chs_azazel", True, False, "chaos"),
    84: factionData("wh3_dlc20_chs_festus", True, True, "chaos"),
    85: factionData("wh3_dlc20_chs_valkia", True, False, "chaos"),
    86: factionData("wh3_dlc20_chs_vilitch", True, False, "chaos"),
    87: factionData("wh3_main_chs_shadow_legion", True, False, "chaos"),
    88: factionData("wh_dlc03_bst_beastmen", True, False, "beastmen"),
    89: factionData("wh2_dlc17_bst_malagor", True, False, "beastmen"),
    90: factionData("wh_dlc05_bst_morghur_herd", True, False, "beastmen"),
    91: factionData("wh2_dlc17_bst_taurox", True, False, "beastmen"),
    92: factionData("wh_dlc05_wef_wood_elves", True, True, "woodElves"),
    93: factionData("wh_dlc05_wef_argwylon", True, True, "woodElves"),
    94: factionData("wh2_dlc16_wef_sisters_of_twilight", True, True, "woodElves"),
    95: factionData("wh2_dlc16_wef_drycha", True, True, "woodElves"),
    96: factionData("wh_main_brt_bretonnia", True, True, "bretonnia"),
    97: factionData("wh_main_brt_carcassonne", True, True, "bretonnia"),
    98: factionData("wh_main_brt_bordeleaux", True, True, "bretonnia"),
    99: factionData("wh2_dlc14_brt_chevaliers_de_lyonesse", True, True, "bretonnia"),
    100: factionData("wh_dlc08_nor_norsca", True, True, "norsca"),
    101: factionData("wh3_dlc27_nor_sayl", True, True, "norsca"),
    102: factionData("wh_dlc08_nor_wintertooth", True, True, "norsca"),
    103: factionData("wh3_main_kho_bloody_sword", False, True, "ai"),
    104: factionData("wh3_main_kho_brazen_throne", False, True, "ai"),
    105: factionData("wh3_main_kho_crimson_skull", False, True, "ai"),
    106: factionData("wh3_main_nur_bubonic_swarm", False, True, "ai"),
    107: factionData("wh3_main_nur_maggoth_kin", False, True, "ai"),
    108: factionData("wh3_dlc20_nur_pallid_nurslings", False, True, "ai"),
    109: factionData("wh3_main_sla_exquisite_pain", False, True, "ai"),
    110: factionData("wh3_main_sla_rapturous_excess", False, True, "ai"),
    111: factionData("wh3_main_sla_subtle_torture", False, True, "ai"),
    112: factionData("wh3_dlc20_sla_keepers_of_bliss", False, True, "ai"),
    113: factionData("wh3_main_tze_all_seeing_eye", False, True, "ai"),
    114: factionData("wh3_main_tze_broken_[wheel", False, True, "ai"),
    115: factionData("wh3_main_tze_flaming_scribes", False, True, "ai"),
    116: factionData("wh3_main_ksl_ropsmenn_clan", False, True, "ai"),
    117: factionData("wh3_dlc20_tze_the_sightless", False, True, "ai"),
    118: factionData("wh3_dlc20_tze_apostles_of_change", False, True, "ai"),
    119: factionData("wh3_main_tze_sarthoraels_watchers", False, True, "ai"),
    120: factionData("wh3_main_ksl_brotherhood_of_the_bear", False, True, "ai"),
    121: factionData("wh3_main_ksl_druzhina_enclave", False, True, "ai"),
    122: factionData("wh3_main_ksl_ungol_kindred", False, True, "ai"),
    123: factionData("wh3_main_ogr_blood_guzzlers", False, True, "ai"),
    124: factionData("wh3_main_ogr_crossed_clubs", False, True, "ai"),
    125: factionData("wh3_main_ogre_sharktooth", False, False, "ai"),
    126: factionData("wh3_main_ogre_stoneshatter", False, False, "ai"),
    127: factionData("wh3_main_ogr_feastmaster", False, False, "ai"),
    128: factionData("wh3_main_ogre_the_famished", False, True, "ai"),
    129: factionData("wh3_main_ogre_flamegullets", False, False, "ai"),
    130: factionData("wh3_main_ogr_fleshgreeders", False, True, "ai"),
    131: factionData("wh3_main_ogr_fulg", False, True, "ai"),
    132: factionData("wh3_main_ogr_lazarghs", False, True, "ai"),
    133: factionData("wh3_main_ogr_mountaineaters", False, True, "ai"),
    134: factionData("wh3_main_ogr_rock_skulls", False, True, "ai"),
    135: factionData("wh3_main_ogr_sabreskin", False, True, "ai"),
    136: factionData("wh3_main_ogr_sons_of_the_mountain", False, True, "ai"),
    137: factionData("wh3_main_ogr_thunderguts", False, True, "ai"),
    138: factionData("wh3_main_ogr_treehammers", False, False, "ai"),
    139: factionData("wh3_main_cth_burning_wind_nomads", False, True, "ai"),
    140: factionData("wh3_main_cth_celestial_loyalists", False, True, "ai"),
    141: factionData("wh3_main_cth_dissenter_lords_of_jinshen", False, True, "ai"),
    142: factionData("wh3_main_cth_eastern_river_lords", False, True, "ai"),
    143: factionData("wh3_main_cth_imperial_wardens", False, True, "ai"),
    144: factionData("wh3_main_cth_rebel_lords_of_nan_yang", False, True, "ai"),
    145: factionData("wh3_main_cth_the_jade_custodians", False, True, "ai"),
    146: factionData("wh2_main_hef_caledor", False, True, "ai"),
    147: factionData("wh2_main_hef_chrace", False, True, "ai"),
    148: factionData("wh2_main_hef_citadel_of_dusk", False, True, "ai"),
    149: factionData("wh2_main_hef_cothique", False, True, "ai"),
    150: factionData("wh2_main_hef_ellyrion", False, True, "ai"),
    151: factionData("wh2_main_hef_saphery", False, True, "ai"),
    152: factionData("wh2_main_hef_tiranoc", False, True, "ai"),
    153: factionData("wh2_main_hef_tor_elasor", False, True, "ai"),
    154: factionData("wh2_main_lzd_sentinels_of_xeti", False, True, "ai"),
    155: factionData("wh2_main_lzd_southern_sentinels", False, True, "ai"),
    156: factionData("wh3_main_lzd_tepoks_spawn", False, True, "ai"),
    157: factionData("wh2_main_lzd_tlaxtlan", False, True, "ai"),
    158: factionData("wh2_dlc16_lzd_wardens_of_the_living_pools", False, True, "ai"),
    159: factionData("wh2_main_lzd_xlanhuapec", False, True, "ai"),
    160: factionData("wh2_main_lzd_zlatan", False, True, "ai"),
    161: factionData("wh2_main_def_bleak_holds", False, True, "ai"),
    162: factionData("wh2_main_def_blood_hall_coven", False, True, "ai"),
    163: factionData("wh2_main_def_clar_karond", False, True, "ai"),
    164: factionData("wh2_main_def_cult_of_excess", False, True, "ai"),
    165: factionData("wh2_main_def_deadwood_sentinels", False, True, "ai"),
    166: factionData("wh2_main_def_ghrond", False, True, "ai"),
    167: factionData("wh2_main_def_karond_kar", False, True, "ai"),
    168: factionData("wh2_main_def_scourge_of_khaine", False, True, "ai"),
    169: factionData("wh2_main_def_ssildra_tor", False, True, "ai"),
    170: factionData("wh2_main_def_drackla_coven", False, True, "ai"),
    171: factionData("wh2_main_def_the_forgebound", False, True, "ai"),
    172: factionData("wh3_main_skv_clan_carrion", False, True, "ai"),
    173: factionData("wh2_dlc16_skv_clan_gritus", False, True, "ai"),
    174: factionData("wh2_dlc15_skv_clan_kreepus", False, True, "ai"),
    175: factionData("wh3_main_skv_clan_krizzor", False, True, "ai"),
    176: factionData("wh2_dlc12_skv_clan_mange", False, True, "ai"),
    177: factionData("wh3_main_skv_clan_morbidus", False, True, "ai"),
    178: factionData("wh2_main_skv_clan_mordkin", False, True, "ai"),
    179: factionData("wh2_main_skv_clan_septik", False, True, "ai"),
    180: factionData("wh3_main_skv_clan_skrat", False, True, "ai"),
    181: factionData("wh2_main_skv_clan_spittel", False, True, "ai"),
    182: factionData("wh3_main_skv_clan_verms", False, True, "ai"),
    183: factionData("wh3_main_skv_clan_treecherik", False, True, "ai"),
    184: factionData("wh3_main_tmb_deserters_of_khatep", False, True, "ai"),
    185: factionData("wh2_dlc09_tmb_dune_kingdoms", False, True, "ai"),
    186: factionData("wh2_dlc09_tmb_numas", False, True, "ai"),
    187: factionData("wh2_dlc09_tmb_rakaph_dynasty", False, True, "ai"),
    188: factionData("wh2_dlc09_tmb_the_sentinels", False, True, "ai"),
    189: factionData("wh2_dlc11_cst_vampire_coast_rebels", False, True, "ai"),
    190: factionData("wh3_dlc21_cst_dead_flag_fleet", False, True, "ai"),
    191: factionData("wh_main_emp_averland", False, True, "ai"),
    192: factionData("wh_main_emp_empire_separatists", False, True, "ai"),
    193: factionData("wh_main_emp_hochland", False, True, "ai"),
    194: factionData("wh_main_emp_marienburg", False, True, "ai"),
    195: factionData("wh_main_emp_middenland", False, True, "ai"),
    196: factionData("wh2_main_emp_new_world_colonies", False, True, "ai"),
    197: factionData("wh_main_emp_nordland", False, True, "ai"),
    198: factionData("wh_main_emp_ostermark", False, True, "ai"),
    199: factionData("wh_main_emp_ostland", False, True, "ai"),
    200: factionData("wh_main_emp_stirland", False, True, "ai"),
    201: factionData("wh_main_emp_talabecland", False, True, "ai"),
    202: factionData("wh_main_dwf_barak_varr", False, True, "ai"),
    203: factionData("wh2_dlc15_dwf_clan_helhein", False, True, "ai"),
    204: factionData("wh2_main_dwf_greybeards_prospectors", False, True, "ai"),
    205: factionData("wh3_main_dwf_karak_azorn", False, True, "ai"),
    206: factionData("wh_main_dwf_karak_azul", False, True, "ai"),
    207: factionData("wh_main_dwf_karak_hirn", False, True, "ai"),
    208: factionData("wh_main_dwf_karak_norn", False, True, "ai"),
    209: factionData("wh_main_dwf_karak_ziflin", False, True, "ai"),
    210: factionData("wh2_main_dwf_spine_of_sotek_dwarfs", False, True, "ai"),
    211: factionData("wh_main_dwf_zhufbar", False, True, "ai"),
    212: factionData("wh2_main_grn_arachnos", False, True, "ai"),
    213: factionData("wh_main_grn_black_venom", False, True, "ai"),
    214: factionData("wh_main_grn_bloody_spearz", False, True, "ai"),
    215: factionData("wh2_main_grn_blue_vipers", False, True, "ai"),
    216: factionData("wh2_dlc16_grn_naggaroth_orcs", False, True, "ai"),
    217: factionData("wh_main_grn_broken_nose", False, True, "ai"),
    218: factionData("wh2_dlc16_grn_creeping_death", False, True, "ai"),
    219: factionData("wh3_dlc26_grn_cluster_eye_tribe", False, True, "ai"),
    220: factionData("wh_main_grn_necksnappers", False, True, "ai"),
    221: factionData("wh3_main_grn_da_cage_breakaz", False, True, "ai"),
    222: factionData("wh3_main_grn_dark_land_orcs", False, True, "ai"),
    223: factionData("wh3_main_grn_dimned_sun", False, True, "ai"),
    224: factionData("wh3_main_grn_drippin_fangs", False, True, "ai"),
    225: factionData("wh2_dlc12_grn_leaf_cutterz_tribe", False, True, "ai"),
    226: factionData("wh3_main_grn_moon_howlerz", False, True, "ai"),
    227: factionData("wh_main_grn_red_eye", False, True, "ai"),
    228: factionData("wh2_dlc14_grn_red_cloud", False, True, "ai"),
    229: factionData("wh_main_grn_red_fangs", False, True, "ai"),
    230: factionData("wh_main_grn_scabby_eye", False, True, "ai"),
    231: factionData("wh_main_grn_skull-takerz", False, False, "ai"),
    232: factionData("wh2_dlc15_grn_skull_crag", False, True, "ai"),
    233: factionData("wh_main_grn_skullsmasherz", False, True, "ai"),
    234: factionData("wh3_main_grn_slaves_of_zharr", False, True, "ai"),
    235: factionData("wh_main_grn_teef_snatchaz", False, True, "ai"),
    236: factionData("wh_dlc03_grn_black_pit", False, True, "ai"),
    237: factionData("wh_main_grn_top_knotz", False, True, "ai"),
    238: factionData("wh3_main_grn_tusked_sunz", False, True, "ai"),
    239: factionData("wh3_dlc21_vmp_jiangshi_rebels", False, True, "ai"),
    240: factionData("wh3_main_vmp_lahmian_sisterhood", False, True, "ai"),
    241: factionData("wh_main_vmp_mousillon", False, True, "ai"),
    242: factionData("wh2_main_vmp_necrarch_brotherhood", False, True, "ai"),
    243: factionData("wh3_main_ie_vmp_sires_of_mourkain", False, True, "ai"),
    244: factionData("wh2_main_vmp_strygos_empire", False, True, "ai"),
    245: factionData("wh_main_vmp_rival_sylvanian_vamps", False, True, "ai"),
    246: factionData("wh2_main_vmp_the_silver_host", False, True, "ai"),
    247: factionData("wh3_dlc25_vmp_the_court_of_night", False, True, "ai"),
    248: factionData("wh3_main_chs_khazag", False, True, "ai"),
    249: factionData("wh_main_teb_border_princes", False, True, "ai"),
    250: factionData("wh_main_teb_estalia", False, True, "ai"),
    251: factionData("wh_main_teb_tilea", False, True, "ai"),
    252: factionData("wh_dlc03_bst_jagged_horn", False, False, "aiHorde"),
    253: factionData("wh2_main_bst_manblight", False, False, "aiHorde"),
    254: factionData("wh_dlc03_bst_redhorn", False, False, "aiHorde"),
    255: factionData("wh2_main_bst_ripper_horn", False, False, "aiHorde"),
    256: factionData("wh2_main_bst_shadowgor", False, False, "ai"),
    257: factionData("wh2_main_wef_bowmen_of_oreon", False, True, "ai"),
    258: factionData("wh3_main_wef_laurelorn", False, True, "ai"),
    259: factionData("wh3_dlc21_wef_spirits_of_shanlin", False, True, "ai"),
    260: factionData("wh_dlc05_wef_torgovann", False, True, "ai"),
    261: factionData("wh_dlc05_wef_wydrioth", False, True, "ai"),
    262: factionData("wh_main_brt_artois", False, True, "ai"),
    263: factionData("wh_main_brt_bastonne", False, True, "ai"),
    264: factionData("wh3_main_brt_aquitaine", False, True, "ai"),
    265: factionData("wh2_main_brt_knights_of_origo", False, True, "ai"),
    266: factionData("wh2_main_brt_knights_of_the_flame", False, True, "ai"),
    267: factionData("wh_main_brt_lyonesse", False, True, "ai"),
    268: factionData("wh_main_brt_parravon", False, True, "ai"),
    269: factionData("wh2_main_brt_thegans_crusaders", False, True, "ai"),
    270: factionData("wh_main_nor_aesling", False, True, "ai"),
    271: factionData("wh2_main_nor_aghol", False, True, "ai"),
    272: factionData("wh3_dlc23_chd_minor_faction", False, True, "ai"),
    273: factionData("wh3_dlc23_chd_conclave", False, True, "ai"),
    274: factionData("wh_main_nor_baersonling", False, True, "ai"),
    275: factionData("wh_main_nor_bjornling", False, True, "ai"),
    276: factionData("wh3_dlc20_nor_dolgan", False, True, "ai"),
    277: factionData("wh_dlc08_nor_goromadny_tribe", False, True, "ai"),
    278: factionData("wh3_dlc20_nor_kul", False, True, "ai"),
    279: factionData("wh2_main_nor_mung", False, True, "ai"),
    280: factionData("wh_dlc08_nor_naglfarlings", False, True, "ai"),
    281: factionData("wh_main_nor_sarl", False, True, "ai"),
    282: factionData("wh_main_nor_skaeling", False, True, "ai"),
    283: factionData("wh2_main_nor_skeggi", False, True, "ai"),
    284: factionData("wh_dlc08_nor_vanaheimlings", False, True, "ai"),
    285: factionData("wh_main_nor_varg", False, True, "ai"),
    286: factionData("wh3_dlc27_nor_avags", False, True, "ai"),
    287: factionData("wh3_dlc21_nor_wyrmkins", False, True, "ai"),
    288: factionData("wh3_dlc20_nor_yusak", False, True, "ai"),
    289: factionData("wh2_dlc11_cst_rogue_bleak_coast_buccaneers", False, False, "aiHorde"),
    290: factionData("wh2_dlc11_cst_rogue_boyz_of_the_forbidden_coast", False, False, "aiHorde"),
    291: factionData("wh2_dlc11_cst_rogue_freebooters_of_port_royale", False, False, "aiHorde"),
    292: factionData("wh2_dlc11_cst_rogue_grey_point_scuttlers", False, False, "aiHorde"),
    293: factionData("wh2_dlc11_cst_rogue_terrors_of_the_dark_straights", False, False, "aiHorde"),
    294: factionData("wh2_dlc11_cst_rogue_the_churning_gulf_raiders", False, False, "aiHorde"),
    295: factionData("wh2_dlc11_cst_rogue_tyrants_of_the_black_ocean", False, False, "aiHorde"),
}
...
settlementDict: dict[int, settlementData] = {
     ...
     55: settlementData('wh3_main_combi_region_stormvrack_mount', 'regular', 809, 828, '', '', ''),
     56: settlementData('wh3_main_combi_region_terracotta_graveyard', 'regular', 1200, 631, '', '', ''),
     57: settlementData('wh3_main_combi_region_the_awakening', 'regular', 276, 262, '', '', ''),
     ...
     64: settlementData('wh3_main_combi_region_tower_of_gorgoth', 'regular', 904, 527, '', '', ''),
     ...
     81: settlementData('wh3_main_combi_region_lybaras', 'regular', 825, 317, '', '', ''),
     ...
     96: settlementData('wh3_main_combi_region_village_of_the_moon', 'regular', 1251, 551, '', '', ''),
     97: settlementData('wh3_main_combi_region_fu_hung', 'regular', 1230, 376, 'wh3_main_cth_burning_wind_nomads', 'temperate', 'Fu Hung'),
     98: settlementData('wh3_main_combi_region_great_desert_of_araby', 'regular', 487, 267, '', '', ''),
     ...
     101: settlementData('wh3_main_combi_region_fort_oberstyre', 'regular', 668, 621, '', '', ''),
     102: settlementData('wh3_main_combi_region_troll_fjord', 'regular', 386, 795, '', '', ''),
     ...
     105: settlementData('wh3_main_combi_region_zanbaijin', 'regular', 1002, 838, '', '', ''),
     106: settlementData('wh3_main_combi_region_kunlan', 'regular', 1251, 587, '', '', ''),
     ...
     113: settlementData('wh3_main_combi_region_the_gallows_tree', 'regular', 975, 819, '', '', ''),
     ...
     116: settlementData('wh3_main_combi_region_tower_of_the_sun', 'regular', 981, 133, '', '', ''),
     117: settlementData('wh3_main_combi_region_fateweavers_crevasse', 'regular', 510, 27, '', '', ''),
     118: settlementData('wh3_main_combi_region_the_godless_crater', 'regular', 235, 22, '', '', ''),
     ...
     121: settlementData('wh3_main_combi_region_rothkar_spire', 'regular', 13, 733, '', '', ''),
     122: settlementData('wh3_main_combi_region_the_daemons_stump', 'regular', 969, 546, '', '', ''),
     ...
     126: settlementData('wh3_main_combi_region_martek', 'regular', 489, 317, '', '', ''),
     127: settlementData('wh3_main_combi_region_ka_sabar', 'regular', 642, 247, '', '', ''),
     128: settlementData('wh3_main_combi_region_gateway_to_khuresh', 'regular', 1257, 349, '', '', ''),
     ...
     136: settlementData('wh3_main_combi_region_languille', 'regular', 384, 661, '', '', ''),
     ...
     142: settlementData('wh3_main_combi_region_the_fortress_of_vorag', 'regular', 889, 438, '', '', ''),
     ...
     152: settlementData('wh3_main_combi_region_weng_chang', 'regular', 1172, 609, '', '', ''),
     ...
     157: settlementData('wh3_main_combi_region_cuexotl', 'regular', 640, 169, '', '', ''),
     ...
     159: settlementData('wh3_main_combi_region_swartzhafen', 'regular', 674, 593, '', '', ''),
     160: settlementData('wh3_main_combi_region_eye_of_the_panther', 'regular', 481, 307, '', '', ''),
     ...
     168: settlementData('wh3_main_combi_region_the_galleons_graveyard', 'regular', 257, 448, '', '', ''),
     ...
     177: settlementData('wh3_main_combi_region_daemons_gate', 'regular', 463, 57, '', '', ''),
     ...
     186: settlementData('wh3_main_combi_region_soteks_trail', 'regular', 710, 163, '', '', ''),
     ...
     188: settlementData('wh3_main_combi_region_kraka_drak', 'regular', 709, 841, 'wh3_dlc25_dwf_malakai', '', ''),
     189: settlementData('wh3_main_combi_region_tor_elasor', 'regular', 911, 78, '', '', ''),
     ...
     201: settlementData('wh3_main_combi_region_the_falls_of_doom', 'regular', 910, 652, '', '', ''),
     202: settlementData('wh3_main_combi_region_castle_artois', 'regular', 410, 639, 'wh_main_brt_artois', 'temperate', 'Castle Artois'),
     203: settlementData('wh3_main_combi_region_tower_of_the_stars', 'regular', 936, 173, '', '', ''),
     ...
     207: settlementData('wh3_main_combi_region_wizard_caliphs_palace', 'regular', 437, 269, '', '', ''),
     ...
     209: settlementData('wh3_main_combi_region_ruins_end', 'regular', 947, 427, '', '', ''),
     ...
     214: settlementData('wh3_main_combi_region_karak_zorn', 'regular', 682, 221, '', '', ''),
     215: settlementData('wh3_main_combi_region_the_black_pit', 'regular', 510, 705, '', '', ''),
     ...
     219: settlementData('wh3_main_combi_region_deaths_head_monoliths', 'regular', 497, 200, '', '', ''),
     ...
     223: settlementData('wh3_main_combi_region_tlax', 'regular', 259, 289, '', '', ''),
     ...
     227: settlementData('wh3_main_combi_region_hualotal', 'regular', 99, 309, '', '', ''),
     ...
     232: settlementData('wh3_main_combi_region_riffraffa', 'regular', 519, 435, '', '', ''),
     ...
     240: settlementData('wh3_main_combi_region_the_blood_hall', 'regular', 26, 332, '', '', ''),
     241: settlementData('wh3_main_combi_region_volcanos_heart', 'regular', 697, 941, '', '', ''),
     ...
     248: settlementData('wh3_main_combi_region_okkams_forever_maze', 'regular', 709, 28, '', '', ''),
     249: settlementData('wh3_main_combi_region_sorcerers_islands', 'regular', 420, 309, '', '', ''),
     ...
     252: settlementData('wh3_main_combi_region_the_oak_of_ages', 'regular', 513, 531, '', '', ''),
     ...
     266: settlementData('wh3_main_combi_region_eilhart', 'regular', 482, 639, 'wh_main_emp_empire', '', ''),
     267: settlementData('wh3_main_combi_region_black_rock', 'regular', 583, 938, '', '', ''),
     ...
     274: settlementData('wh3_main_combi_region_slavers_point', 'regular', 238, 753, '', '', ''),
     ...
     287: settlementData('wh3_main_combi_region_nuln', 'regular', 553, 607, '', '', ''),
     288: settlementData('wh3_main_combi_region_karak_krakaten', 'regular', 1003, 491, 'wh3_main_ogr_goldtooth', 'mountain', 'Karak Krakaten'),
     289: settlementData('wh3_main_combi_region_mountain_pass', 'regular', 1322, 335, '', '', ''),
     290: settlementData('wh3_main_combi_region_citadel_of_lead', 'regular', 355, 763, 'wh3_dlc20_tze_the_sightless', '', ''),
     ...
     298: settlementData('wh3_main_combi_region_khymerica_spire', 'regular', 29, 705, '', '', ''),
     299: settlementData('wh3_dlc23_combi_region_gash_kadrak', 'regular', 943, 601, '', '', ''),
     ...
     303: settlementData('wh3_main_combi_region_zharr_naggrund', 'regular', 943, 628, '', '', ''),
     304: settlementData('wh3_main_combi_region_eschen', 'regular', 714, 635, '', '', ''),
     ...
     312: settlementData('wh3_dlc23_combi_region_uzkulak_port', 'regular', 859, 740, '', '', ''),
     ...
     333: settlementData('wh3_main_combi_region_hoteks_column', 'regular', 173, 718, '', '', ''),
     334: settlementData('wh3_main_combi_region_the_crystal_spires', 'regular', 749, 926, '', '', ''),
     ...
     349: settlementData('wh3_main_combi_region_eagle_eyries', 'regular', 962, 665, '', '', ''),
     350: settlementData('wh3_main_combi_region_gryphon_wood', 'regular', 669, 682, 'wh2_dlc16_wef_drycha', '', ''),
     ...
     357: settlementData('wh3_main_combi_region_the_blighted_grove', 'regular', 560, 953, '', '', ''),
     ...
     364: settlementData('wh3_main_combi_region_ubersreik', 'regular', 505, 614, 'wh_main_emp_empire', '', ''),
     ...
     372: settlementData('wh3_main_combi_region_ironspike', 'regular', 43, 547, '', '', ''),
     373: settlementData('wh3_main_combi_region_teotiqua', 'regular', 740, 187, 'wh2_main_skv_clan_mordkin', 'jungle', 'Teotiqua'),
     374: settlementData('wh3_main_combi_region_shang_wu', 'regular', 1164, 479, '', '', ''),
     375: settlementData('wh3_main_combi_region_plain_of_spiders', 'regular', 40, 677, '', '', ''),
     ...
     378: settlementData('wh3_main_combi_region_gnashraks_lair', 'regular', 792, 643, '', '', ''),
     ...
     380: settlementData('wh3_main_combi_region_scarpels_lair', 'regular', 15, 600, '', '', ''),
     381: settlementData('wh3_main_combi_region_shroktak_mount', 'regular', 57, 768, None, 'mountain', 'Shroktak Mount'),
     382: settlementData('wh3_main_combi_region_ssildra_tor', 'regular', 64, 535, '', '', ''),
     ...
     393: settlementData('wh3_main_combi_region_the_witchwood', 'regular', 66, 660, '', '', ''),
     394: settlementData('wh3_main_combi_region_jungles_of_chian', 'regular', 1303, 386, '', '', ''),
     ...
     402: settlementData('wh3_main_combi_region_black_fortress', 'regular', 950, 479, '', '', ''),
     ...
     409: settlementData('wh3_main_combi_region_khazid_bordkarag', 'regular', 687, 823, '', '', ''),
     ...
     414: settlementData('wh3_main_combi_region_statues_of_the_gods', 'regular', 545, 175, '', '', ''),
     ...
     419: settlementData('wh3_main_combi_region_po_mei', 'regular', 1228, 649, '', '', ''),
     ...
     422: settlementData('wh3_main_combi_region_vauls_anvil_ulthuan', 'regular', 204, 511, '', '', ''),
     423: settlementData('wh3_main_combi_region_the_gates_of_zharr', 'regular', 916, 564, '', '', ''),
     ...
     430: settlementData('wh3_main_combi_region_the_volary', 'regular', 1111, 716, '', '', ''),
     ...
     440: settlementData('wh3_main_combi_region_castle_drakenhof', 'regular', 716, 612, '', '', ''),
     ...
     445: settlementData('wh3_main_combi_region_pox_marsh', 'regular', 298, 283, '', '', ''),
     446: settlementData('wh3_main_combi_region_floating_pyramid', 'regular', 104, 394, '', '', ''),
     ...
     448: settlementData('wh3_main_combi_region_kings_glade', 'regular', 512, 519, '', '', ''),
     449: settlementData('wh3_main_combi_region_waili_village', 'regular', 1267, 383, '', '', ''),
     ...
     452: settlementData('wh3_main_combi_region_valayas_sorrow', 'regular', 737, 446, '', '', ''),
     ...
     462: settlementData('wh3_main_combi_region_titans_notch', 'regular', 1047, 635, '', '', ''),
     463: settlementData('wh3_main_combi_region_averheim', 'regular', 615, 599, 'wh_main_emp_averland', 'temperate', 'Averheim'),
     464: settlementData('wh3_main_combi_region_temple_of_tlencan', 'regular', 215, 335, '', '', ''),
     ...
     472: settlementData('wh3_main_combi_region_sun_tree_glades', 'regular', 609, 180, '', '', ''),
     ...
     478: settlementData('wh3_main_combi_region_oreons_camp', 'regular', 641, 216, '', '', ''),
     479: settlementData('wh3_main_combi_region_tor_anroc', 'regular', 178, 593, 'wh2_main_hef_tiranoc', 'temperate island', 'Tor Anroc'),
     480: settlementData('wh3_main_combi_region_nan_li', 'regular', 1143, 626, '', '', ''),
     481: settlementData('wh3_main_combi_region_whitepeak', 'regular', 171, 571, 'wh2_main_hef_tiranoc', 'temperate island', 'Whitepeak'),
     482: settlementData('wh3_main_combi_region_couronne', 'regular', 410, 675, '', '', ''),
     483: settlementData('wh3_main_combi_region_mount_thug', 'regular', 1053, 461, '', '', ''),
     ...
     485: settlementData('wh3_main_combi_region_petrified_forest', 'regular', 77, 557, '', '', ''),
     ...
     488: settlementData('wh3_main_combi_region_monolith_of_flesh', 'regular', 600, 894, '', '', ''),
     489: settlementData('wh3_main_combi_region_karak_ziflin', 'regular', 476, 608, 'wh_main_dwf_karak_ziflin', 'mountain', 'Karak Ziflin'),
     490: settlementData('wh3_main_combi_region_dawns_light', 'regular', 584, 57, '', '', ''),
     ...
     496: settlementData('wh3_main_combi_region_isle_of_the_crimson_skull', 'regular', 62, 407, '', '', ''),
     497: settlementData('wh3_main_combi_region_port_of_secrets', 'regular', 718, 900, '', '', ''),
     498: settlementData('wh3_main_combi_region_galbaraz', 'regular', 624, 377, 'wh_main_grn_top_knotz', 'wasteland', 'Galbaraz'),
     499: settlementData('wh3_main_combi_region_the_tower_of_flies', 'regular', 684, 921, '', '', ''),
     500: settlementData('wh3_main_combi_region_the_forest_of_decay', 'regular', 640, 939, '', '', ''),
     ...
     503: settlementData('wh3_main_combi_region_zarakzil', 'regular', 539, 451, '', '', ''),
     ...
     507: settlementData('wh3_main_combi_region_waldenhof', 'regular', 720, 648, '', '', ''),
     ...
     516: settlementData('wh3_main_combi_region_temple_of_kara', 'regular', 152, 366, '', '', ''),
     517: settlementData('wh3_dlc23_combi_region_fort_dorznye_vort', 'regular', 885, 692, '', '', ''),
     ...
     528: settlementData('wh3_main_combi_region_shiyamas_rest', 'regular', 1269, 460, '', '', ''),
     529: settlementData('wh3_main_combi_region_tor_sethai', 'regular', 206, 530, 'wh2_main_hef_caledor', 'temperate island', 'Tor Sethai'),
     530: settlementData('wh3_main_combi_region_grotrilexs_glare_lighthouse', 'regular', 412, 51, '', '', ''),
     531: settlementData('wh3_main_combi_region_castle_templehof', 'regular', 686, 628, '', '', ''),
     532: settlementData('wh3_main_combi_region_luccini', 'regular', 505, 410, 'wh_main_teb_tilea', 'temperate', 'Luccini'),
     533: settlementData('wh3_main_combi_region_grunburg', 'regular', 548, 623, 'wh_main_emp_empire', '', ''),
     534: settlementData('wh3_main_combi_region_brass_keep', 'regular', 592, 737, '', '', ''),
     ...
     538: settlementData('wh3_dlc23_combi_region_blasted_expanse', 'regular', 858, 634, '', '', ''),
     ...
     540: settlementData('wh3_main_combi_region_dagraks_end', 'regular', 128, 909, '', '', ''),
     ...
     542: settlementData('wh3_main_combi_region_wreckers_point', 'regular', 474, 748, '', '', ''),
     ...
     548: settlementData('wh3_main_combi_region_uzkulak', 'regular', 854, 723, '', '', ''),
     ...
     561: settlementData('wh3_main_combi_region_black_crag', 'regular', 753, 483, '', '', ''),
     562: settlementData('wh3_main_combi_region_karag_dron', 'regular', 752, 517, '', '', ''),
