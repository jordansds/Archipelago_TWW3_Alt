...
class faction(Choice):
    ...
    option_Mixu_Legendary_Lords_Molokh_Slugtongue = 255
    option_Mixu_Legendary_Lords_Ghorros_Warhoof = 257
    option_Mixu_Legendary_Lords_Chilfroy_d_Artois = 264
    option_Mixu_Legendary_Lords_Bohemond_Beastslayer = 265
    option_Mixu_Legendary_Lords_Sir_John_Tyreweld = 267
    option_Mixu_Legendary_Lords_Adalhard_de_Lyonesse = 269
    option_Mixu_Legendary_Lords_Cassyon_de_Parravon = 270
    option_Mixu_Legendary_Lords_Tullaris_Dreadbringer = 169
    option_Mixu_Legendary_Lords_Kazador_Dragonslayer = 208
    option_Mixu_Legendary_Lords_Grimm_Burloksson = 213
    option_Mixu_Legendary_Lords_Marius_Leitdorf = 193
    option_Mixu_Legendary_Lords_Aldebrand_Ludenhof = 195
    option_Mixu_Legendary_Lords_Theoderic_Gausser = 199
    option_Mixu_Legendary_Lords_Wolfram_Hertwig = 200
    option_Mixu_Legendary_Lords_Valmir_von_Raukov = 201
    option_Mixu_Legendary_Lords_Alberich_Haupt_Anderssen = 202
    option_Mixu_Legendary_Lords_Helmut_Feuerbach = 203
    option_Mixu_Legendary_Lords_Edvard_van_der_Kraal = 1003
    option_Mixu_Legendary_Lords_Gorfang_Rotgut = 231
    option_Mixu_Legendary_Lords_Korhil = 147
    option_Mixu_Legendary_Lords_Belannaer_the_Wise = 151
    option_Mixu_Legendary_Lords_Rastiltin_Bebchuk = 120
    option_Mixu_Legendary_Lords_Lord_Huinitenuchli = 158
    option_Mixu_Legendary_Lords_Tetto_eko = 160
    option_Mixu_Legendary_Lords_Warlord_Feskit = 179
    option_Mixu_Legendary_Lords_King_Tutankhanut = 187
    option_Mixu_Legendary_Lords_Dieter_Helsnicht = 1004
    option_Mixu_Legendary_Lords_Egrimm_van_Horstmann = 1005
    option_Mixu_Legendary_Lords_Slaa_Ulaan = 1006
    option_Mixu_Legendary_Lords_Egil_Styrbjorn = 284
    option_Mixu_Legendary_Lords_Daith = 262
    option_Mixu_Legendary_Lords_Naieth = 263
    ...
    option_Cataph_Southern_Realms_Lucrezzia_Belladonna = 1019
    option_Cataph_Southern_Realms_Leonardo_Catrazza = 1020
