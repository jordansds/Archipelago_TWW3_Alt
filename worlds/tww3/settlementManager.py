...
factionDict: dict[int, factionData] = {
    ...
    1: factionData('wh3_main_kho_exiles_of_khorne', True, True, 'daemons', 'Skarbrand (Khorne)'),
    2: factionData('wh3_dlc26_kho_skulltaker', True, True, 'daemons', 'Skulltaker (Khorne)'),
    3: factionData('wh3_dlc26_kho_arbaal', True, True, 'daemons', 'Arbaal the Undefeated (Khorne)'),
    4: factionData('wh3_main_nur_poxmakers_of_nurgle', True, True, 'daemons', "Ku'gath Plaguefather (Nurgle)"),
    5: factionData('wh3_dlc25_nur_tamurkhan', True, True, 'daemons', 'Tamurkhan the Maggot Lord (Nurgle)'),
    6: factionData('wh3_dlc25_nur_epidemius', True, True, 'daemons', 'Epidemius (Nurgle)'),
    7: factionData('wh3_main_sla_seducers_of_slaanesh', True, True, 'daemons', "N'Kari (Slaanesh)"),
    8: factionData('wh3_dlc27_sla_the_tormentors', True, False, 'daemons', 'Dechala, the Denied One (Slaanesh)'),
    9: factionData('wh3_dlc27_sla_masque_of_slaanesh', True, True, 'daemons', 'The Masque of Slaanesh (Slaanesh)'),
    10: factionData('wh3_main_tze_oracles_of_tzeentch', True, True, 'daemons', 'Kairos Fateweaver (Tzeentch)'),
    11: factionData('wh3_dlc24_tze_the_deceivers', True, False, 'daemons', 'The Changeling (Tzeentch)'),
