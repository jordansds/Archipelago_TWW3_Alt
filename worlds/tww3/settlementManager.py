...
factionDict: dict[int, factionData] = {
    ...
    16: factionData('wh3_main_ogr_goldtooth', True, True, 'ogres', 'Greasus Goldtooth (Ogre Kingdoms)', False),
    17: factionData('wh3_main_ogr_disciples_of_the_maw', True, True, 'ogres', 'Skrag the Slaughterer (Ogre Kingdoms)', False),
    18: factionData('wh3_dlc26_ogr_golgfag', True, False, 'ogres', 'Golgfag Maneater (Ogre Kingdoms)', True),
