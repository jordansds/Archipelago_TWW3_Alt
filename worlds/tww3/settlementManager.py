...
factionDict: dict[int, factionData] = {
    ...
    103: factionData('wh3_main_kho_bloody_sword', False, True, 'ai', None, False),
    104: factionData('wh3_main_kho_brazen_throne', False, True, 'ai', None, False),
    105: factionData('wh3_main_kho_crimson_skull', False, True, 'ai', None, False),
    106: factionData('wh3_main_nur_bubonic_swarm', False, True, 'ai', None, False),
    107: factionData('wh3_main_nur_maggoth_kin', False, True, 'ai', None, False),
    108: factionData('wh3_dlc20_nur_pallid_nurslings', False, True, 'ai', None, False),
    109: factionData('wh3_main_sla_exquisite_pain', False, True, 'ai', None, False),
    110: factionData('wh3_main_sla_rapturous_excess', False, True, 'ai', None, False),
    111: factionData('wh3_main_sla_subtle_torture', False, True, 'ai', None, False),
    112: factionData('wh3_dlc20_sla_keepers_of_bliss', False, True, 'ai', None, False),
    113: factionData('wh3_main_tze_all_seeing_eye', False, True, 'ai', None, False),
    114: factionData('wh3_main_tze_broken_wheel', False, True, 'ai', None, False),
    115: factionData('wh3_main_tze_flaming_scribes', False, True, 'ai', None, False),
    116: factionData('wh3_main_ksl_ropsmenn_clan', False, True, 'ai', None, False),
    117: factionData('wh3_dlc20_tze_the_sightless', False, True, 'ai', None, False),
    118: factionData('wh3_dlc20_tze_apostles_of_change', False, True, 'ai', None, False),
    119: factionData('wh3_main_tze_sarthoraels_watchers', False, True, 'ai', None, False),
    120: factionData('wh3_main_ksl_brotherhood_of_the_bear', False, True, 'ai', None, False),
    121: factionData('wh3_main_ksl_druzhina_enclave', False, True, 'ai', None, False),
    122: factionData('wh3_main_ksl_ungol_kindred', False, True, 'ai', None, False),
    123: factionData('wh3_main_ogr_blood_guzzlers', False, True, 'ai', None, False),
    124: factionData('wh3_main_ogr_crossed_clubs', False, True, 'ai', None, False),
    125: factionData('wh3_main_ogre_sharktooth', False, False, 'ai', None, False),
    126: factionData('wh3_main_ogre_stoneshatter', False, False, 'ai', None, False),
    127: factionData('wh3_main_ogr_feastmaster', False, False, 'ai', None, False),
    128: factionData('wh3_main_ogre_the_famished', False, True, 'ai', None, False),
    129: factionData('wh3_main_ogre_flamegullets', False, False, 'ai', None, False),
    130: factionData('wh3_main_ogr_fleshgreeders', False, True, 'ai', None, False),
    131: factionData('wh3_main_ogr_fulg', False, True, 'ai', None, False),
    132: factionData('wh3_main_ogr_lazarghs', False, True, 'ai', None, False),
    133: factionData('wh3_main_ogr_mountaineaters', False, True, 'ai', None, False),
    134: factionData('wh3_main_ogr_rock_skulls', False, True, 'ai', None, False),
    135: factionData('wh3_main_ogr_sabreskin', False, True, 'ai', None, False),
    136: factionData('wh3_main_ogr_sons_of_the_mountain', False, True, 'ai', None, False),
    137: factionData('wh3_main_ogr_thunderguts', False, True, 'ai', None, False),
    138: factionData('wh3_main_ogr_treehammers', False, False, 'ai', None, False),
    139: factionData('wh3_main_cth_burning_wind_nomads', False, True, 'ai', None, False),
    140: factionData('wh3_main_cth_celestial_loyalists', False, True, 'ai', None, False),
    141: factionData('wh3_main_cth_dissenter_lords_of_jinshen', False, True, 'ai', None, False),
    142: factionData('wh3_main_cth_eastern_river_lords', False, True, 'ai', None, False),
    143: factionData('wh3_main_cth_imperial_wardens', False, True, 'ai', None, False),
    144: factionData('wh3_main_cth_rebel_lords_of_nan_yang', False, True, 'ai', None, False),
    145: factionData('wh3_main_cth_the_jade_custodians', False, True, 'ai', None, False),
    146: factionData('wh2_main_hef_caledor', False, True, 'ai', None, False),
    147: factionData('wh2_main_hef_chrace', False, True, 'ai', None, False),
    148: factionData('wh2_main_hef_citadel_of_dusk', False, True, 'ai', None, False),
    149: factionData('wh2_main_hef_cothique', False, True, 'ai', None, False),
    150: factionData('wh2_main_hef_ellyrion', False, True, 'ai', None, False),
    151: factionData('wh2_main_hef_saphery', False, True, 'ai', None, False),
    152: factionData('wh2_main_hef_tiranoc', False, True, 'ai', None, False),
    153: factionData('wh2_main_hef_tor_elasor', False, True, 'ai', None, False),
    154: factionData('wh3_dlc27_hef_aislinn_confederation_owner', False, True, 'ai', None, False),
    155: factionData('wh2_main_lzd_sentinels_of_xeti', False, True, 'ai', None, False),
    156: factionData('wh2_main_lzd_southern_sentinels', False, True, 'ai', None, False),
    157: factionData('wh3_main_lzd_tepoks_spawn', False, True, 'ai', None, False),
    158: factionData('wh2_main_lzd_tlaxtlan', False, True, 'ai', None, False),
    159: factionData('wh2_dlc16_lzd_wardens_of_the_living_pools', False, True, 'ai', None, False),
    160: factionData('wh2_main_lzd_xlanhuapec', False, True, 'ai', None, False),
    161: factionData('wh2_main_lzd_zlatan', False, True, 'ai', None, False),
    162: factionData('wh2_main_def_bleak_holds', False, True, 'ai', None, False),
    163: factionData('wh2_main_def_blood_hall_coven', False, True, 'ai', None, False),
    164: factionData('wh2_main_def_clar_karond', False, True, 'ai', None, False),
    165: factionData('wh2_main_def_cult_of_excess', False, True, 'ai', None, False),
    166: factionData('wh2_main_def_deadwood_sentinels', False, True, 'ai', None, False),
    167: factionData('wh2_main_def_ghrond', False, True, 'ai', None, False),
    168: factionData('wh2_main_def_karond_kar', False, True, 'ai', None, False),
    169: factionData('wh2_main_def_scourge_of_khaine', False, True, 'ai', None, False),
    170: factionData('wh2_main_def_ssildra_tor', False, True, 'ai', None, False),
    171: factionData('wh2_main_def_drackla_coven', False, True, 'ai', None, False),
    172: factionData('wh2_main_def_the_forgebound', False, True, 'ai', None, False),
    173: factionData('wh3_main_skv_clan_carrion', False, True, 'ai', None, False),
    174: factionData('wh2_dlc16_skv_clan_gritus', False, True, 'ai', None, False),
    175: factionData('wh2_dlc15_skv_clan_kreepus', False, True, 'ai', None, False),
    176: factionData('wh3_main_skv_clan_krizzor', False, True, 'ai', None, False),
    177: factionData('wh2_dlc12_skv_clan_mange', False, True, 'ai', None, False),
    178: factionData('wh3_main_skv_clan_morbidus', False, True, 'ai', None, False),
    179: factionData('wh2_main_skv_clan_mordkin', False, True, 'ai', None, False),
    180: factionData('wh2_main_skv_clan_septik', False, True, 'ai', None, False),
    181: factionData('wh3_main_skv_clan_skrat', False, True, 'ai', None, False),
    182: factionData('wh2_main_skv_clan_spittel', False, True, 'ai', None, False),
    183: factionData('wh3_main_skv_clan_verms', False, True, 'ai', None, False),
    184: factionData('wh3_main_skv_clan_treecherik', False, True, 'ai', None, False),
    185: factionData('wh3_main_tmb_deserters_of_khatep', False, True, 'ai', None, False),
    186: factionData('wh2_dlc09_tmb_dune_kingdoms', False, True, 'ai', None, False),
    187: factionData('wh2_dlc09_tmb_numas', False, True, 'ai', None, False),
    188: factionData('wh2_dlc09_tmb_rakaph_dynasty', False, True, 'ai', None, False),
    189: factionData('wh2_dlc09_tmb_the_sentinels', False, True, 'ai', None, False),
    190: factionData('wh2_dlc11_cst_vampire_coast_rebels', False, True, 'ai', None, False),
    191: factionData('wh3_dlc21_cst_dead_flag_fleet', False, True, 'ai', None, False),
    192: factionData('wh3_main_cst_dread_rock_privateers', False, True, 'ai', None, False),
    193: factionData('wh_main_emp_averland', False, True, 'ai', None, False),
    194: factionData('wh_main_emp_empire_separatists', False, True, 'ai', None, False),
    195: factionData('wh_main_emp_hochland', False, True, 'ai', None, False),
    196: factionData('wh_main_emp_marienburg', False, True, 'ai', None, False),
    197: factionData('wh_main_emp_middenland', False, True, 'ai', None, False),
    198: factionData('wh2_main_emp_new_world_colonies', False, True, 'ai', None, False),
    199: factionData('wh_main_emp_nordland', False, True, 'ai', None, False),
    200: factionData('wh_main_emp_ostermark', False, True, 'ai', None, False),
    201: factionData('wh_main_emp_ostland', False, True, 'ai', None, False),
    202: factionData('wh_main_emp_stirland', False, True, 'ai', None, False),
    203: factionData('wh_main_emp_talabecland', False, True, 'ai', None, False),
    204: factionData('wh_main_dwf_barak_varr', False, True, 'ai', None, False),
    205: factionData('wh2_dlc15_dwf_clan_helhein', False, True, 'ai', None, False),
    206: factionData('wh2_main_dwf_greybeards_prospectors', False, True, 'ai', None, False),
    207: factionData('wh3_main_dwf_karak_azorn', False, True, 'ai', None, False),
    208: factionData('wh_main_dwf_karak_azul', False, True, 'ai', None, False),
    209: factionData('wh_main_dwf_karak_hirn', False, True, 'ai', None, False),
    210: factionData('wh_main_dwf_karak_norn', False, True, 'ai', None, False),
    211: factionData('wh_main_dwf_karak_ziflin', False, True, 'ai', None, False),
    212: factionData('wh2_main_dwf_spine_of_sotek_dwarfs', False, True, 'ai', None, False),
    213: factionData('wh_main_dwf_zhufbar', False, True, 'ai', None, False),
    214: factionData('wh2_main_grn_arachnos', False, True, 'ai', None, False),
    215: factionData('wh_main_grn_black_venom', False, True, 'ai', None, False),
    216: factionData('wh_main_grn_bloody_spearz', False, True, 'ai', None, False),
    217: factionData('wh2_main_grn_blue_vipers', False, True, 'ai', None, False),
    218: factionData('wh2_dlc16_grn_naggaroth_orcs', False, True, 'ai', None, False),
    219: factionData('wh_main_grn_broken_nose', False, True, 'ai', None, False),
    220: factionData('wh2_dlc16_grn_creeping_death', False, True, 'ai', None, False),
    221: factionData('wh3_dlc26_grn_cluster_eye_tribe', False, True, 'ai', None, False),
    222: factionData('wh_main_grn_necksnappers', False, True, 'ai', None, False),
    223: factionData('wh3_main_grn_da_cage_breakaz', False, True, 'ai', None, False),
    224: factionData('wh3_main_grn_dark_land_orcs', False, True, 'ai', None, False),
    225: factionData('wh3_main_grn_dimned_sun', False, True, 'ai', None, False),
    226: factionData('wh3_main_grn_drippin_fangs', False, True, 'ai', None, False),
    227: factionData('wh2_dlc12_grn_leaf_cutterz_tribe', False, True, 'ai', None, False),
    228: factionData('wh3_main_grn_moon_howlerz', False, True, 'ai', None, False),
    229: factionData('wh_main_grn_red_eye', False, True, 'ai', None, False),
    230: factionData('wh2_dlc14_grn_red_cloud', False, True, 'ai', None, False),
    231: factionData('wh_main_grn_red_fangs', False, True, 'ai', None, False),
    232: factionData('wh_main_grn_scabby_eye', False, True, 'ai', None, False),
    233: factionData('wh_main_grn_skull-takerz', False, False, 'ai', None, False),
    234: factionData('wh2_dlc15_grn_skull_crag', False, True, 'ai', None, False),
    235: factionData('wh_main_grn_skullsmasherz', False, True, 'ai', None, False),
    236: factionData('wh3_main_grn_slaves_of_zharr', False, True, 'ai', None, False),
    237: factionData('wh_main_grn_teef_snatchaz', False, True, 'ai', None, False),
    238: factionData('wh_dlc03_grn_black_pit', False, True, 'ai', None, False),
    239: factionData('wh_main_grn_top_knotz', False, True, 'ai', None, False),
    240: factionData('wh3_main_grn_tusked_sunz', False, True, 'ai', None, False),
    241: factionData('wh3_dlc21_vmp_jiangshi_rebels', False, True, 'ai', None, False),
    242: factionData('wh3_main_vmp_lahmian_sisterhood', False, True, 'ai', None, False),
    243: factionData('wh_main_vmp_mousillon', False, True, 'ai', None, False),
    244: factionData('wh2_main_vmp_necrarch_brotherhood', False, True, 'ai', None, False),
    245: factionData('wh3_main_ie_vmp_sires_of_mourkain', False, True, 'ai', None, False),
    246: factionData('wh2_main_vmp_strygos_empire', False, True, 'ai', None, False),
    247: factionData('wh_main_vmp_rival_sylvanian_vamps', False, True, 'ai', None, False),
    248: factionData('wh2_main_vmp_the_silver_host', False, True, 'ai', None, False),
    249: factionData('wh3_dlc25_vmp_the_court_of_night', False, True, 'ai', None, False),
    250: factionData('wh3_main_chs_khazag', False, True, 'ai', None, False),
    251: factionData('wh_main_teb_border_princes', False, True, 'ai', None, False),
    252: factionData('wh_main_teb_estalia', False, True, 'ai', None, False),
    253: factionData('wh_main_teb_tilea', False, True, 'ai', None, False),
    254: factionData('wh_dlc03_bst_jagged_horn', False, False, 'ai', None, True),
    255: factionData('wh2_main_bst_manblight', False, False, 'ai', None, True),
    256: factionData('wh_dlc03_bst_redhorn', False, False, 'ai', None, True),
    257: factionData('wh2_main_bst_ripper_horn', False, False, 'ai', None, True),
    258: factionData('wh2_main_bst_shadowgor', False, False, 'ai', None, False),
    259: factionData('wh2_main_wef_bowmen_of_oreon', False, True, 'woodElves', None, False),
    260: factionData('wh3_main_wef_laurelorn', False, True, 'woodElves', None, False),
    261: factionData('wh3_dlc21_wef_spirits_of_shanlin', False, True, 'woodElves', None, False),
    262: factionData('wh_dlc05_wef_torgovann', False, True, 'woodElves', None, False),
    263: factionData('wh_dlc05_wef_wydrioth', False, True, 'woodElves', None, False),
    264: factionData('wh_main_brt_artois', False, True, 'ai', None, False),
    265: factionData('wh_main_brt_bastonne', False, True, 'ai', None, False),
    266: factionData('wh3_main_brt_aquitaine', False, True, 'ai', None, False),
    267: factionData('wh2_main_brt_knights_of_origo', False, True, 'ai', None, False),
    268: factionData('wh2_main_brt_knights_of_the_flame', False, True, 'ai', None, False),
    269: factionData('wh_main_brt_lyonesse', False, True, 'ai', None, False),
    270: factionData('wh_main_brt_parravon', False, True, 'ai', None, False),
    271: factionData('wh2_main_brt_thegans_crusaders', False, True, 'ai', None, False),
    272: factionData('wh_main_nor_aesling', False, True, 'ai', None, False),
    273: factionData('wh2_main_nor_aghol', False, True, 'ai', None, False),
    274: factionData('wh3_dlc23_chd_minor_faction', False, True, 'ai', None, False),
    275: factionData('wh3_dlc23_chd_conclave', False, True, 'ai', None, False),
    276: factionData('wh_main_nor_baersonling', False, True, 'ai', None, False),
    277: factionData('wh_main_nor_bjornling', False, True, 'ai', None, False),
    278: factionData('wh3_dlc20_nor_dolgan', False, True, 'ai', None, False),
    279: factionData('wh_dlc08_nor_goromadny_tribe', False, True, 'ai', None, False),
    280: factionData('wh3_dlc20_nor_kul', False, True, 'ai', None, False),
    281: factionData('wh2_main_nor_mung', False, True, 'ai', None, False),
    282: factionData('wh_dlc08_nor_naglfarlings', False, True, 'ai', None, False),
    283: factionData('wh_main_nor_sarl', False, True, 'ai', None, False),
    284: factionData('wh_main_nor_skaeling', False, True, 'ai', None, False),
    285: factionData('wh2_main_nor_skeggi', False, True, 'ai', None, False),
    286: factionData('wh_dlc08_nor_vanaheimlings', False, True, 'ai', None, False),
    287: factionData('wh_main_nor_varg', False, True, 'ai', None, False),
    288: factionData('wh3_dlc27_nor_avags', False, True, 'ai', None, False),
    289: factionData('wh3_dlc21_nor_wyrmkins', False, True, 'ai', None, False),
    290: factionData('wh3_dlc20_nor_yusak', False, True, 'ai', None, False),
    291: factionData('wh3_dlc27_the_narj', False, True, 'ai', None, False),
    292: factionData('wh2_dlc11_cst_rogue_bleak_coast_buccaneers', False, False, 'aiHorde', None, True),
    293: factionData('wh2_dlc11_cst_rogue_boyz_of_the_forbidden_coast', False, False, 'aiHorde', None, True),
    294: factionData('wh2_dlc11_cst_rogue_freebooters_of_port_royale', False, False, 'aiHorde', None, True),
    295: factionData('wh2_dlc11_cst_rogue_grey_point_scuttlers', False, False, 'aiHorde', None, True),
    296: factionData('wh2_dlc11_cst_rogue_terrors_of_the_dark_straights', False, False, 'aiHorde', None, True),
    297: factionData('wh2_dlc11_cst_rogue_the_churning_gulf_raiders', False, False, 'aiHorde', None, True),
...
modDict: dict[str, dict[int, factionData]] = {
    "mixu mousillon": {1000: factionData('mixer_msl_mallobaude', True, False, 'mousillon', 'Mallobaude (Mousillon)', False),
                       1001: factionData('mixer_msl_cult_of_the_bloody_grail', True, False, 'mousillon', 'Lady of the Black Grail (Mousillon)', False)
    },
    "mixu legendary lords": {255: factionData('wh2_main_bst_manblight', True, False, 'beastmen', 'Molokh Slugtongue (Beastmen)', True),
                             257: factionData('wh2_main_bst_ripper_horn', True, False, 'beastmen', 'Ghorros Warhoof (Beastmen)', True),

                             264: factionData('wh_main_brt_artois', True, True, 'bretonnia', "Chilfroy d'Artois (Bretonnia)", False),
                             265: factionData('wh_main_brt_bastonne', True, True, 'bretonnia', 'Bohemond Beastslayer (Bretonnia)', False),
                             267: factionData('wh2_main_brt_knights_of_origo', True, True, 'bretonnia', 'Sir John Tyreweld (Bretonnia)', False),
                             269: factionData('wh_main_brt_lyonesse', True, True, 'bretonnia', 'Adalhard de Lyonesse (Bretonnia)', False),
                             270: factionData('wh_main_brt_parravon', True, True, 'bretonnia', 'Cassyon de Parravon (Bretonnia)', False),

                             169: factionData('wh2_main_def_scourge_of_khaine', True, True, 'darkElves', 'Tullaris Dreadbringer', False),

                             208: factionData('wh_main_dwf_karak_azul', True, True, 'empire', 'Kazador Dragonslayer (Dwarfs)', False),
                             213: factionData('wh_main_dwf_zhufbar', True, True, 'empire', 'Grimm Burloksson (Dwarfs)', False),

                             193: factionData('wh_main_emp_averland', True, True, 'empire', 'Marius Leitdorf (Empire)', False),
                             195: factionData('wh_main_emp_hochland', True, True, 'empire', 'Aldebrand Ludenhof (Empire)', False),
                             199: factionData('wh_main_emp_nordland', True, True, 'empire', 'Theoderic Gausser (Empire)', False),
                             200: factionData('wh_main_emp_ostermark', True, True, 'empire', 'Wolfram Hertwig (Empire)', False),
                             201: factionData('wh_main_emp_ostland', True, True, 'empire', 'Valmir von Raukov (Empire)', False),
                             202: factionData('wh_main_emp_stirland', True, True, 'empire', 'Alberich Haupt-Anderssen (Empire)', False),
                             203: factionData('wh_main_emp_talabecland', True, True, 'empire', 'Helmut Feuerbach (Empire)', False),
                             1003: factionData('mixer_emp_van_der_kraal', True, False, 'empireEdvard', "Edvard van der Kraal (Empire)", True),

                             231: factionData('wh_main_grn_red_fangs', True, True, 'greenskins', 'Gorfang Rotgut (Greenskins)', False),

                             147: factionData('wh2_main_hef_chrace', True, True, 'highElves', 'Korhil (High Elves)', False),
                             151: factionData('wh2_main_hef_saphery', True, True, 'highElves', 'Belannaer the Wise (High Elves)', False),

                             120: factionData('wh3_main_ksl_brotherhood_of_the_bear', True, True, 'kislev', 'Rastiltin Bebchuk (Kislev)', False),

                             158: factionData('wh2_main_lzd_tlaxtlan', True, True, 'lizardmen', 'Lord Huinitenuchli (Lizardmen)', False),
                             160: factionData('wh2_main_lzd_xlanhuapec', True, True, 'lizardmen', "Tetto'eko (Lizardmen)", False),

                             179: factionData('wh2_main_skv_clan_mordkin', True, True, 'skaven', 'Warlord Feskit (Skaven)', False),

                             187: factionData('wh2_dlc09_tmb_numas', True, True, 'tombKings', 'King Tutankhanut (Tomb Kings)', False),
                             ...
                             284: factionData('wh_main_nor_skaeling', True, True, 'norsca', 'Egil Styrbjorn (Norsca)', False),

                             262: factionData('wh_dlc05_wef_torgovann', True, True, 'woodElves', 'Daith', False),
                             263: factionData('wh_dlc05_wef_wydrioth', True, True, 'woodElves','Naieth', False),
                             1007: factionData('mixer_wef_wychwethyl', True, True, 'woodElves', 'Wychwethyl the Wild', False),
    },
    "ovn citadel of dusk": {
    ...
    "cataph southern realms": {
        ...
        1019: factionData("mixer_teb_bilbali", True, True, "southernRealms", "Lucrezzia Belladonna (Southern Realms)", False),
        1020: factionData("mixer_teb_catrazza", True, True, "southernRealms", "Leonardo Catrazza (Southern Realms)", False),
        1021: factionData("mixer_teb_colombo", True, True, "southernRealms", "Marco Colombo (Southern Realms)", False),
        1022: factionData("mixer_teb_gashnag", True, True, "southernRealms", "Gnashag the Black Prince (Southern Realms)", False),
        1023: factionData("mixer_teb_new_world_colonies", True, True, "southernRealms", "El Cadavo (Southern Realms)", False)
    }
}
