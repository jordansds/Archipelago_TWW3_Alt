...
factionDict: dict[int, factionData] = {
    0: factionData('wh3_main_dae_daemon_prince', True, False, 'daemons', 'The Daemon Prince (Daemons of Chaos)', False),
    1: factionData('wh3_main_kho_exiles_of_khorne', True, True, 'khorne', 'Skarbrand (Khorne)', False),
    2: factionData('wh3_dlc26_kho_skulltaker', True, True, 'khorne', 'Skulltaker (Khorne)', False),
    3: factionData('wh3_dlc26_kho_arbaal', True, True, 'khorne', 'Arbaal the Undefeated (Khorne)', False),
    4: factionData('wh3_main_nur_poxmakers_of_nurgle', True, True, 'nurgle', "Ku'gath Plaguefather (Nurgle)", False),
    5: factionData('wh3_dlc25_nur_tamurkhan', True, True, 'nurgle', 'Tamurkhan the Maggot Lord (Nurgle)', False),
    6: factionData('wh3_dlc25_nur_epidemius', True, True, 'nurgle', 'Epidemius (Nurgle)', False),
    7: factionData('wh3_main_sla_seducers_of_slaanesh', True, True, 'slaanesh', "N'Kari (Slaanesh)", False),
    ...
    15: factionData('wh3_dlc24_ksl_daughters_of_the_forest', True, True, 'kislev', 'Mother Ostankya (Kislev)', False),
    16: factionData('wh3_main_ogr_goldtooth', True, True, 'ogreKingdoms', 'Greasus Goldtooth (Ogre Kingdoms)', False),
    17: factionData('wh3_main_ogr_disciples_of_the_maw', True, True, 'ogreKingdoms', 'Skrag the Slaughterer (Ogre Kingdoms)', False),
    18: factionData('wh3_dlc26_ogr_golgfag', True, False, 'ogreKingdoms', 'Golgfag Maneater (Ogre Kingdoms)', True),
    19: factionData('wh3_dlc23_chd_astragoth', True, True, 'chaosDwarfs', 'Astragoth Ironhand (Chaos Dwarfs)', False),
    20: factionData('wh3_dlc23_chd_legion_of_azgorh', True, True, 'chaosDwarfs', 'Drazhoath the Ashen (Chaos Dwarfs)', False),
    21: factionData('wh3_dlc23_chd_zhatan', True, True, 'chaosDwarfs', 'Zhaten the Black (Chaos Dwarfs)', False),
    22: factionData('wh3_main_cth_the_northern_provinces', True, True, 'cathay', 'Miao Ying, the Storm Dragon (Grand Cathay)', False),
    23: factionData('wh3_main_cth_the_western_provinces', True, True, 'cathay', 'Zhai Ming, the Iron Dragon (Grand Cathay)', False),
    24: factionData('wh3_dlc24_cth_the_celestial_court', True, True, 'cathay', 'Yuan Bo, the Jade Dragon (Grand Cathay)', False),
    103: factionData('wh3_cp1_cth_tiger_warriors', True, True, 'cathayBhashiva', 'Bhashiva, the White Tiger (Grand Cathay)', False),
    25: factionData('wh2_main_hef_eataine', True, True, 'highElves', 'Tyrion (High Elves)', False),
    26: factionData('wh2_main_hef_order_of_loremasters', True, True, 'highElves', 'Teclis (High Elves)', False),
    27: factionData('wh2_main_hef_avelorn', True, True, 'highElves', 'Alarielle the Radiant (High Elves)', False),
    28: factionData('wh2_main_hef_nagarythe', True, True, 'highElves', 'Alith Anar (High Elves)', False),
    29: factionData('wh2_main_hef_yvresse', True, True, 'highElves', 'Eltharion the Grim (High Elves)', False),
    30: factionData('wh2_dlc15_hef_imrik', True, True, 'highElves', 'Imrik (High Elves)', False),
    31: factionData('wh3_dlc27_hef_aislinn', True, False, 'highElvesAislinn', 'Sea Lord Aislinn (High Elves)', True),
    32: factionData('wh2_dlc17_lzd_oxyotl', True, True, 'lizardmen', 'Oxyotl (Lizardmen)', False),
    33: factionData('wh2_main_lzd_hexoatl', True, True, 'lizardmen', 'Lord Mazdamundi (Lizardmen)', False),
    34: factionData('wh2_main_lzd_last_defenders', True, True, 'lizardmen', 'Kroq-Gar (Lizardmen)', False),
    35: factionData('wh2_dlc12_lzd_cult_of_sotek', True, True, 'lizardmen', 'Tehenhauin (Lizardmen)', False),
    36: factionData('wh2_main_lzd_tlaqua', True, True, 'lizardmen', "Tiktaq'to (Lizardmen)", False),
    37: factionData('wh2_dlc13_lzd_spirits_of_the_jungle', True, False, 'lizardmenNakai', 'Nakai the Wanderer (Lizardmen)', True),
    38: factionData('wh2_main_lzd_itza', True, True, 'lizardmen', 'Gor-Rok (Lizardmen)', False),
    39: factionData('wh2_main_def_naggarond', True, True, 'darkElves', 'Malekith (Dark Elves)', False),
    40: factionData('wh2_main_def_cult_of_pleasure', True, True, 'darkElves', 'Morathi (Dark Elves)', False),
    41: factionData('wh2_main_def_har_ganeth', True, True, 'darkElves', 'Crone Helebron (Dark Elves)', False),
    42: factionData('wh2_dlc11_def_the_blessed_dread', True, True, 'darkElves', 'Lokhir Fellheart (Dark Elves)', False),
    43: factionData('wh2_main_def_hag_graef', True, False, 'darkElves', 'Malus Darkblade (Dark Elves)', False),
    44: factionData('wh2_twa03_def_rakarth', True, True, 'darkElves', 'Rakarth the Beastmaster (Dark Elves)', False),
    45: factionData('wh2_main_skv_clan_mors', True, True, 'skaven', 'Queek Headtaker (Skaven)', False),
    46: factionData('wh2_main_skv_clan_pestilens', True, True, 'skaven', 'Lord Skrolk (Skaven)', False),
    47: factionData('wh2_dlc09_skv_clan_rictus', True, True, 'skaven', 'Tretch Craventail (Skaven)', False),
    48: factionData('wh2_main_skv_clan_skryre', True, True, 'skaven', 'Ikit Claw (Skaven)', False),
    49: factionData('wh2_main_skv_clan_moulder', True, True, 'skaven', 'Throt the Unclean (Skaven)', False),
    50: factionData('wh2_main_skv_clan_eshin', True, True, 'skaven', 'Deathmaster Snikch (Skaven)', False),
    51: factionData('wh2_dlc09_tmb_khemri', True, True, 'tombKings','Settra The Imperishable (Tomb Kings)', False),
    52: factionData('wh2_dlc09_tmb_lybaras', True, True, 'tombKings', 'High Queen Khalida (Tomb Kings)', False),
    53: factionData('wh2_dlc09_tmb_exiles_of_nehek', True, True, 'tombKings', 'Grand Hierophant Khatep (Tomb Kings)', False),
    54: factionData('wh2_dlc09_tmb_followers_of_nagash', True, True, 'tombKings', 'Arkhan the Black (Tomb Kings)', False),
    55: factionData('wh2_dlc11_cst_vampire_coast', True, True, 'vampireCoast', 'Luthor Harkon (Vampire Coast)', False),
    56: factionData('wh2_dlc11_cst_noctilus', True, True, 'vampireCoast', 'Count Noctilus (Vampire Coast)', False),
    57: factionData('wh2_dlc11_cst_the_drowned', True, True, 'vampireCoast', 'Cylostra Direfin (Vampire Coast)', False),
    58: factionData('wh2_dlc11_cst_pirates_of_sartosa', True, True, 'vampireCoast', 'Aranessa Saltspite (Vampire Coast)', False),
    59: factionData('wh_main_emp_empire', True, True, 'empire', 'Karl Franz (Empire)', False),
    60: factionData('wh2_dlc13_emp_golden_order', True, False, 'empire', 'Balthasar Gelt (Empire)', False),
    61: factionData('wh3_main_emp_cult_of_sigmar', True, True, 'empire', 'Volkmar the Grim (Empire)', False),
    62: factionData('wh2_dlc13_emp_the_huntmarshals_expedition', True, True, 'empire', 'Markus Wulfhart (Empire)', False),
    63: factionData('wh_main_emp_wissenland', True, True, 'empire', 'Elspeth Von Draken (Empire)', False),
    64: factionData('wh_main_dwf_dwarfs', True, True, 'dwarfs', 'Thorgrim Grudgebearer (Dwarfs)', False),
    65: factionData('wh_main_dwf_karak_kadrin', True, True, 'dwarfs', 'Ungrim Ironfist (Dwarfs)', False),
    66: factionData('wh_main_dwf_karak_izor', True, True, 'dwarfs', 'Belegar Ironhammer (Dwarfs)', False),
    67: factionData('wh3_main_dwf_the_ancestral_throng', True, True, 'dwarfs', 'Grombrindal - The White Dwarf (Dwarfs)', False),
    68: factionData('wh2_dlc17_dwf_thorek_ironbrow', True, True, 'dwarfs', 'Thorek Ironbrow (Dwarfs)', False),
    69: factionData('wh3_dlc25_dwf_malakai', True, True, 'dwarfs', 'Malakai Makaisson (Dwarfs)', False),
    70: factionData('wh_main_grn_greenskins', True, True, 'greenskins', 'Grimgor Ironhide (Greenskins)', False),
    71: factionData('wh_main_grn_crooked_moon', True, True, 'greenskins', 'Skarsnik (Greenskins)', False),
    72: factionData('wh2_dlc15_grn_bonerattlaz', True, True, 'greenskins', 'Azhag the Slaughterer (Greenskins)', False),
    73: factionData('wh_main_grn_orcs_of_the_bloody_hand', True, True, 'greenskins', 'Wurrzag da Great Green Prophet (Greenskins)', False),
    74: factionData('wh2_dlc15_grn_broken_axe', True, True, 'greenskins', 'Grom the Paunch (Greenskins)', False),
    75: factionData('wh3_dlc26_grn_gorbad_ironclaw', True, True, 'greenskins', 'Gorbad Ironclaw (Greenskins)', False),
    76: factionData('wh_main_vmp_vampire_counts', True, True, 'vampireCounts', 'Mannfred von Carstein (Vampire Counts)', False),
    77: factionData('wh2_dlc11_vmp_the_barrow_legion', True, True, 'vampireCounts', 'Heinrich Kemmler (Vampire Counts)', False),
    78: factionData('wh3_main_vmp_caravan_of_blue_roses', True, True, 'vampireCounts', 'Helman Ghorst (Vampire Counts)', False),
    79: factionData('wh_main_vmp_schwartzhafen', True, True, 'vampireCounts', 'Vlad von Carstein (Vampire Counts)', False),
    80: factionData('wh_main_chs_chaos', True, False, 'chaos', 'Archaon the Everchosen (Warriors of Chaos)', False),
    81: factionData('wh3_dlc20_chs_kholek', True, False, 'chaos', 'Kholek Suneater (Warriors of Chaos)', False),
    82: factionData('wh3_dlc20_chs_sigvald', True, False, 'chaos', 'Prince Sigvald the Magnificent (Warriors of Chaos)', False),
    83: factionData('wh3_dlc20_chs_azazel', True, False, 'chaosSlaanesh', 'Azazel (Warriors of Chaos)', False),
    84: factionData('wh3_dlc20_chs_festus', True, True, 'chaosNurgle', 'Festus the Leechlord (Warriors of Chaos)', False),
    85: factionData('wh3_dlc20_chs_valkia', True, False, 'chaosKhorne', 'Valkia the Bloody (Warriors of Chaos)', False),
    86: factionData('wh3_dlc20_chs_vilitch', True, False, 'chaosTzeentch', 'Vilitch the Cursling (Warriors of Chaos)', False),
    87: factionData('wh3_main_chs_shadow_legion', True, False, 'chaos', "Be'lakor (Warriors of Chaos)", False),
    88: factionData('wh_dlc03_bst_beastmen', True, False, 'beastmen', 'Khazrak the One-Eye (Beastmen)', True),
    89: factionData('wh2_dlc17_bst_malagor', True, False, 'beastmen', 'Malagor the Dark Omen (Beastmen)', True),
    90: factionData('wh_dlc05_bst_morghur_herd', True, False, 'beastmen', 'Morghur the Shadowgave (Beastmen)', True),
    91: factionData('wh2_dlc17_bst_taurox', True, False, 'beastmen', 'Taurox the Brass Bull (Beastmen)', True),
    92: factionData('wh_dlc05_wef_wood_elves', True, True, 'woodElves', 'Orion (Wood Elves)', False),
    93: factionData('wh_dlc05_wef_argwylon', True, True, 'woodElves', 'Durthu (Wood Elves)', False),
    94: factionData('wh2_dlc16_wef_sisters_of_twilight', True, True, 'woodElves', 'Sisters of Twilight (Wood Elves)', False),
    95: factionData('wh2_dlc16_wef_drycha', True, True, 'woodElves', 'Drycha (Wood Elves)', False),
    96: factionData('wh_main_brt_bretonnia', True, True, 'bretonnia', 'King Louen Leoncoeur (Bretonnia)', False),
    97: factionData('wh_main_brt_carcassonne', True, True, 'bretonnia', 'Fay Enchantress (Bretonnia)', False),
    98: factionData('wh_main_brt_bordeleaux', True, True, 'bretonnia', 'Alberic de Bordeleaux (Bretonnia)', False),
    99: factionData('wh2_dlc14_brt_chevaliers_de_lyonesse', True, True, 'bretonnia', 'Repanse de Lyonesse (Bretonnia)', False),
    100: factionData('wh_dlc08_nor_norsca', True, True, 'norsca', 'Wulfrik the Wanderer (Norsca)', False),
    101: factionData('wh3_dlc27_nor_sayl', True, True, 'norsca', 'Sayl the Faithless (Sayl)', False),
    102: factionData('wh_dlc08_nor_wintertooth', True, True, 'norsca', 'Throgg (Norsca)', False),
...
modDict: dict[str, dict[int, factionData]] = {
    "mixu mousillon": {2000: factionData('mixer_msl_mallobaude', True, False, 'mousillon', 'Mallobaude (Mousillon)', False),
                       2001: factionData('mixer_msl_cult_of_the_bloody_grail', True, False, 'mousillon', 'Lady of the Black Grail (Mousillon)', False)
    },
