...
techs: dict[int, itemData] = {
    112800: itemData(IC.useful, 1, "cn_tech_0_growth", itemType.tech, 1, "Progressive tech_crb_head", "Crustacean Tech: Future of Crabkind"),
    112801: itemData(IC.useful, 1, "cn_tech_head_1", itemType.tech, 2, "Progressive tech_crb_head", "Crustacean Tech: Martial Claw"),

    112802: itemData(IC.useful, 1, "cn_tech_left_claw_0", itemType.tech, 1, "Progressive tech_crb_left_claw", "Crustacean Tech: Military Training"),
    112803: itemData(IC.useful, 1, "cn_tech_left_claw_1", itemType.tech, 2, "Progressive tech_crb_left_claw", "Crustacean Tech: Bullet Workshops"),
    112804: itemData(IC.useful, 1, "cn_tech_left_claw_1b", itemType.tech, 2, "Progressive tech_crb_left_claw", "Crustacean Tech: Improved Throwing Technique"),
    112805: itemData(IC.useful, 1, "cn_tech_left_claw_2", itemType.tech, 3, "Progressive tech_crb_left_claw", "Crustacean Tech: Defensive Formation"),
    112806: itemData(IC.useful, 1, "cn_tech_left_claw_3b", itemType.tech, 4, "Progressive tech_crb_left_claw", "Crustacean Tech: Marching Drills"),
    112807: itemData(IC.useful, 1, "cn_tech_left_claw_3", itemType.tech, 4, "Progressive tech_crb_left_claw", "Crustacean Tech: Sneaky Scuttlers"),
    112808: itemData(IC.useful, 1, "cn_tech_left_claw_3c", itemType.tech, 5, "Progressive tech_crb_left_claw", "Crustacean Tech: Heavy Munitions"),
    112809: itemData(IC.useful, 1, "cn_tech_left_claw_4", itemType.tech, 5, "Progressive tech_crb_left_claw", "Crustacean Tech: Weapon Maintenance"),
    112810: itemData(IC.useful, 1, "cn_tech_left_claw_5", itemType.tech, 5, "Progressive tech_crb_left_claw", "Crustacean Tech: Military Stockpiles"),
    112811: itemData(IC.useful, 1, "cn_tech_left_claw_6", itemType.tech, 5, "Progressive tech_crb_left_claw", "Crustacean Tech: Finest Armaments"),
    112812: itemData(IC.useful, 1, "cn_tech_left_claw_6b", itemType.tech, 6, "Progressive tech_crb_left_claw", "Crustacean Tech: Specialist Training"),
    112813: itemData(IC.useful, 1, "cn_tech_left_claw_7", itemType.tech, 6, "Progressive tech_crb_left_claw", "Crustacean Tech: Royal Traditions"),
    112814: itemData(IC.useful, 1, "cn_tech_left_claw_7b", itemType.tech, 6, "Progressive tech_crb_left_claw", "Crustacean Tech: Officers Academy"),
    112815: itemData(IC.useful, 1, "cn_tech_left_claw_8", itemType.tech, 7, "Progressive tech_crb_left_claw", "Crustacean Tech: Release the Kraken"),
    112816: itemData(IC.useful, 1, "cn_tech_left_claw_9", itemType.tech, 8, "Progressive tech_crb_left_claw", "Crustacean Tech: Crustacean Dominion"),

    112817: itemData(IC.useful, 1, "cn_tech_right_claw_0", itemType.tech, 1, "Progressive tech_crb_right_claw", "Crustacean Tech: Reinforced Clubs"),
    112818: itemData(IC.useful, 1, "cn_tech_right_claw_1", itemType.tech, 2, "Progressive tech_crb_right_claw", "Crustacean Tech: Padded Saddles"),
    112819: itemData(IC.useful, 1, "cn_tech_right_claw_1b", itemType.tech, 2, "Progressive tech_crb_right_claw", "Crustacean Tech: Free-range Training"),
    112820: itemData(IC.useful, 1, "cn_tech_right_claw_2", itemType.tech, 3, "Progressive tech_crb_right_claw", "Crustacean Tech: Ironclaw Teachings"),
    112821: itemData(IC.useful, 1, "cn_tech_right_claw_3b", itemType.tech, 4, "Progressive tech_crb_right_claw", "Crustacean Tech: Bigger Casting Molds"),
    112822: itemData(IC.useful, 1, "cn_tech_right_claw_3", itemType.tech, 4, "Progressive tech_crb_right_claw", "Crustacean Tech: Selective Breeding"),
    112823: itemData(IC.useful, 1, "cn_tech_right_claw_3c", itemType.tech, 5, "Progressive tech_crb_right_claw", "Crustacean Tech: Natural Selection"),
    112824: itemData(IC.useful, 1, "cn_tech_right_claw_4", itemType.tech, 5, "Progressive tech_crb_right_claw", "Crustacean Tech: Ancestral Resilience"),
    112825: itemData(IC.useful, 1, "cn_tech_right_claw_5", itemType.tech, 5, "Progressive tech_crb_right_claw", "Crustacean Tech: Unstoppable Onslaught"),
    112826: itemData(IC.useful, 1, "cn_tech_right_claw_6", itemType.tech, 5, "Progressive tech_crb_right_claw", "Crustacean Tech: Elite Training Regimens"),
    112827: itemData(IC.useful, 1, "cn_tech_right_claw_6b", itemType.tech, 6, "Progressive tech_crb_right_claw", "Crustacean Tech: Mighty Champions"),
    112828: itemData(IC.useful, 1, "cn_tech_right_claw_7", itemType.tech, 6, "Progressive tech_crb_right_claw", "Crustacean Tech: Transcribe Ancient Texts"),
    112829: itemData(IC.useful, 1, "cn_tech_right_claw_7b", itemType.tech, 6, "Progressive tech_crb_right_claw", "Crustacean Tech: Hardshell Elites"),
    112830: itemData(IC.useful, 1, "cn_tech_right_claw_8", itemType.tech, 7, "Progressive tech_crb_right_claw", "Crustacean Tech: Awakening of the Elders"),
    112831: itemData(IC.useful, 1, "cn_tech_right_claw_9", itemType.tech, 8, "Progressive tech_crb_right_claw", "Crustacean Tech: Crustacean Supremacy"),

    112832: itemData(IC.useful, 1, "cn_tech_left_leg_0", itemType.tech, 1, "Progressive tech_crb_left_leg", "Crustacean Tech: Cast Expansion"),
    112833: itemData(IC.useful, 1, "cn_tech_left_leg_1", itemType.tech, 2, "Progressive tech_crb_left_leg", "Crustacean Tech: Long Term Planning"),
    112834: itemData(IC.useful, 1, "cn_tech_left_leg_2", itemType.tech, 2, "Progressive tech_crb_left_leg", "Crustacean Tech: Coastline Development"),
    112835: itemData(IC.useful, 1, "cn_tech_left_leg_3", itemType.tech, 2, "Progressive tech_crb_left_leg", "Crustacean Tech: Crusty Tax Reforms"),
    112836: itemData(IC.useful, 1, "cn_tech_left_leg_4", itemType.tech, 2, "Progressive tech_crb_left_leg", "Crustacean Tech: Kelp Farming Techniques"),

    112837: itemData(IC.useful, 1, "cn_tech_right_leg_0", itemType.tech, 1, "Progressive tech_crb_right_leg", "Crustacean Tech: Crab King's Tithes"),
    112838: itemData(IC.useful, 1, "cn_tech_right_leg_1", itemType.tech, 2, "Progressive tech_crb_right_leg", "Crustacean Tech: Clawkin Solidarity"),
    112839: itemData(IC.useful, 1, "cn_tech_right_leg_2", itemType.tech, 2, "Progressive tech_crb_right_leg", "Crustacean Tech: Inspect Foreign Visitors"),
    112840: itemData(IC.useful, 1, "cn_tech_right_leg_3", itemType.tech, 2, "Progressive tech_crb_right_leg", "Crustacean Tech: Coral Healing Serum"),
    112841: itemData(IC.useful, 1, "cn_tech_right_leg_4", itemType.tech, 2, "Progressive tech_crb_right_leg", "Crustacean Tech: Crustworthy Allies"),
}
...
progTechs: dict[int, itemData] = {
    113401: itemData(IC.useful, 2, "Progressive tech_crb_head", itemType.tech, 2, None, "Progressive Crustacean Tech: Martial Claw"),
    113416: itemData(IC.useful, 8, "Progressive tech_crb_left_claw", itemType.tech, 8, None, "Progressive Crustacean Tech: Crustacean Dominion"),
    113431: itemData(IC.useful, 8, "Progressive tech_crb_right_claw", itemType.tech, 8, None, "Progressive Crustacean Tech: Crustacean Supremacy"),
    113436: itemData(IC.useful, 2, "Progressive tech_crb_left_leg", itemType.tech, 2, None, "Progressive Crustacean Tech: Kelp Farming Techniques"),
    113441: itemData(IC.useful, 2, "Progressive tech_crb_right_leg", itemType.tech, 2, None, "Progressive Crustacean Tech: Crustworthy Allies"),
}
