...
special: dict[int, specialItemData] = {
    111500: specialItemData(IC.useful, 1, ["mixer_teb_border_princes","mixer_teb_gashnag", "mixer_teb_tilea", "mixer_teb_estalia", "mixer_teb_bilbali", "mixer_teb_catrazza"], "teb_kotrs", itemType.unit, 2, "Progressive teb_cav", False, False, "SouthernRealms Unit: Knights of the Righteous Spear"),
    111501: specialItemData(IC.useful, 1, ["mixer_teb_border_princes", "mixer_teb_gashnag", "mixer_teb_tilea", "mixer_teb_estalia", "mixer_teb_bilbali", "mixer_teb_catrazza"], "teb_sisters", itemType.unit, 4, "Progressive teb_inf", False, False, "SouthernRealms Unit: Sisters of Fury"),
    ...
    111512: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_estalia", "mixer_teb_bilbali", "mixer_teb_catrazza", "mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_pikemen",  itemType.unit, 2, "Progressive teb_inf", False, False, "SouthernRealms Unit: Pikemen"),
    111513: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza"], "teb_republican_guard", itemType.unit, 3, "Progressive teb_inf", False, False, "SouthernRealms Unit: Republican Guard"),
    111514: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_estalia", "mixer_teb_bilbali", "mixer_teb_catrazza", "mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_montante_greatswords", itemType.unit, 4, "Progressive teb_inf", False, False, "SouthernRealms Unit: Montante Swordsmen"),
    111515: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza", "mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_pavisiers", itemType.unit, 2, "Progressive teb_rng", False, False, "SouthernRealms Unit: Pavise Crossbowmen"),
    111516: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza"], "teb_broken_lances", itemType.unit, 2, "Progressive teb_cav", False, False, "SouthernRealms Unit: Broken Lances"),
    111517: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza", "mixer_teb_estalia", "mixer_teb_bilbali", "mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_noble_retinue", itemType.unit, 3, "Progressive teb_cav", False, False, "SouthernRealms Unit: Noble Retinue"),
    111518: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza"], "teb_carabiniers", itemType.unit, 3, "Progressive teb_cav", False, False, "SouthernRealms Unit: Carabiniers"),
    111519: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza"], "teb_encarmine", itemType.unit, 3, "Progressive teb_cav", False, False, "SouthernRealms Unit: Knights Encarmine"),
    111520: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza", "mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_galloper", itemType.unit, 1, "Progressive teb_art", False, False, "SouthernRealms Unit: Galloper Guns"),
    ...
    111532: specialItemData(IC.useful, 1, ["mixer_teb_border_princes"], "teb_tech_classical_sub_BP", itemType.tech, 2, "Progressive tech_teb_middle", False, False, "SouthernRealms Tech: Phalanxes"),
    111533: specialItemData(IC.useful, 1, ["mixer_teb_border_princes", "mixer_teb_estalia", "mixer_teb_tilea", "mixer_teb_bilbali", "mixer_teb_catrazza"], "teb_tech_dorf", itemType.tech, 1, "Progressive tech_teb_lower", False, False, "SouthernRealms Tech: Dwarfen Allies"),
    111534: specialItemData(IC.useful, 1, ["mixer_teb_border_princes"], "teb_tech_myrmidia_sub_BP", itemType.tech, 1, "Progressive tech_teb_lower", False, False, "SouthernRealms Tech: Importing the Orders"),
    111535: specialItemData(IC.useful, 1, ["mixer_teb_border_princes"], "teb_tech_rebuild", itemType.tech, 2, "Progressive tech_teb_lower", False, False, "SouthernRealms Tech: Frontier No More"),

    111536: specialItemData(IC.useful, 1, ["mixer_teb_estalia", "mixer_teb_bilbali"], "teb_tech_mercs_sub_estalia", itemType.tech, 2, "Progressive tech_teb_upper", False, False, "SouthernRealms Tech: Irregulars"),
    111537: specialItemData(IC.useful, 1, ["mixer_teb_estalia", "mixer_teb_bilbali"], "teb_tech_tercio", itemType.tech, 2, "Progressive tech_teb_upper", False, False, "SouthernRealms Tech: Expeditionary Tercios"),
    111538: specialItemData(IC.useful, 1, ["mixer_teb_estalia", "mixer_teb_bilbali"], "teb_tech_conquistadores", itemType.tech, 2, "Progressive tech_teb_middle", False, False, "SouthernRealms Tech: Conquistador Lords"),
    111539: specialItemData(IC.useful, 1, ["mixer_teb_estalia", "mixer_teb_bilbali"], "teb_tech_inquisition", itemType.tech, 2, "Progressive tech_teb_lower", False, False, "SouthernRealms Tech: Grand Estalian Inquisition"),

    111540: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza"], "teb_tech_tilean", itemType.tech, 2, "Progressive tech_teb_upper", False, False, "SouthernRealms Tech: Tilean Renown"),
    111541: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza"], "teb_tech_supremacy", itemType.tech, 2, "Progressive tech_teb_middle", False, False, "SouthernRealms Tech: Tilean Supremacy"),
    111542: specialItemData(IC.useful, 1, ["mixer_teb_tilea", "mixer_teb_catrazza"], "teb_tech_empire", itemType.tech, 2, "Progressive tech_teb_lower", False, False, "SouthernRealms Tech: Dreams of Empire"),

    111543: specialItemData(IC.useful, 1, ["mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_tech_bestofworst", itemType.tech, 2, "Progressive tech_teb_upper", False, False, "SouthernRealms Tech: The Best of the Worst"),
    111544: specialItemData(IC.useful, 1, ["mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_tech_conquistadores_col", itemType.tech, 2, "Progressive tech_teb_middle", False, False, "SouthernRealms Tech: Fear the Reaver"),
    111545: specialItemData(IC.useful, 1, ["mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_tech_oldones", itemType.tech, 1, "Progressive tech_teb_lower", False, False, "SouthernRealms Tech: Legacy of the Old Ones"),
    111546: specialItemData(IC.useful, 1, ["mixer_teb_colombo", "mixer_teb_new_world_colonies"], "teb_tech_bravenewworld", itemType.tech, 2, "Progressive tech_teb_lower", False, False, "SouthernRealms Tech: Brave New World"),
