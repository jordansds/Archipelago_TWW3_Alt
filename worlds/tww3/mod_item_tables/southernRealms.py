...
progBuildings: dict[int, itemData] = {
    ...
    111301: itemData(IC.useful, 1, "Progressive teb_port", itemType.building, 3, None, "Progressive SouthernRealms Building: Barracks"),
    111302: itemData(IC.useful, 1, "Progressive teb_mercs", itemType.building, 3, None, "Progressive SouthernRealms Building: Mercenaries"),
    111303: itemData(IC.useful, 1, "Progressive teb_artillery", itemType.building, 2, None, "Progressive SouthernRealms Building: Artillery"),
    111304: itemData(IC.useful, 1, "Progressive teb_smith", itemType.building, 2, None, "Progressive SouthernRealms Building: Smithy"),
    111305: itemData(IC.useful, 1, "Progressive teb_worship_myrmidia", itemType.building, 5, None, "Progressive SouthernRealms Building: Cult of Myrmidia"),
    111306: itemData(IC.useful, 1, "Progressive teb_worship_shallya", itemType.building, 5, None, "Progressive SouthernRealms Building: Cult of Shallya"),
    111307: itemData(IC.useful, 1, "Progressive teb_badmercs", itemType.building, 3, None, "Progressive SouthernRealms Building: Mercenary Warfare"),
    111308: itemData(IC.useful, 1, "Progressive teb_walls", itemType.building, 5, None, "Progressive SouthernRealms Building: Walls"),
    111309: itemData(IC.useful, 1, "Progressive teb_foreign_slot_discovery", itemType.building, 3, None, "Progressive SouthernRealms Building: Protection"),
    111310: itemData(IC.useful, 1, "Progressive teb_garrison", itemType.building, 3, None, "Progressive SouthernRealms Building: Garrison"),
    111311: itemData(IC.useful, 1, "Progressive teb_farm", itemType.building, 5, None, "Progressive SouthernRealms Building: Farms"),
    111312: itemData(IC.useful, 1, "Progressive teb_industry", itemType.building, 5, None, "Progressive SouthernRealms Building: Industry"),
    111313: itemData(IC.useful, 1, "Progressive teb_wine", itemType.building, 5, None, "Progressive SouthernRealms Building: Order"),
    111314: itemData(IC.useful, 1, "Progressive teb_trade", itemType.building, 5, None, "Progressive SouthernRealms Building: Trade"),
    111315: itemData(IC.useful, 1, "Progressive teb_roads", itemType.building, 2, None, "Progressive SouthernRealms Building: Roads"),
    111316: itemData(IC.useful, 1, 'Progressive teb_settlement_major', itemType.building, 5, None, 'Progressive SouthernRealms Building: Settlement Major'),
    111317: itemData(IC.useful, 1, 'Progressive teb_settlement_minor', itemType.building, 3, None, 'Progressive SouthernRealms Building: Settlement Minor'),
    111318: itemData(IC.useful, 1, "Progressive teb_resource_iron", itemType.building, 3, None, "Progressive SouthernRealms Building: Iron"),
    111319: itemData(IC.useful, 1, "Progressive teb_resource_salt", itemType.building, 3, None, "Progressive SouthernRealms Building: Salt"),
    111320: itemData(IC.useful, 1, "Progressive teb_resource_animals", itemType.building, 3, None, "Progressive SouthernRealms Building: Animals"),
    111321: itemData(IC.useful, 1, "Progressive teb_resource_gold", itemType.building, 3, None, "Progressive SouthernRealms Building: Gold"),
    111322: itemData(IC.useful, 1, "Progressive teb_resource_pastures", itemType.building, 3, None, "Progressive SouthernRealms Building: Pastures"),
    111323: itemData(IC.useful, 1, "Progressive teb_resource_timber", itemType.building, 3, None, "Progressive SouthernRealms Building: Timber"),
    111324: itemData(IC.useful, 1, 'Progressive teb_resource_medicine', itemType.building, 3, None, 'Progressive SouthernRealms Building: Medicine'),
    111325: itemData(IC.useful, 1, 'Progressive teb_resource_obsidian', itemType.building, 3, None, 'Progressive SouthernRealms Building: Obsidian'),
    111326: itemData(IC.useful, 1, 'Progressive teb_resource_spices', itemType.building, 3, None, 'Progressive SouthernRealms Building: Spices'),
    111327: itemData(IC.useful, 1, 'Progressive teb_resource_ivory', itemType.building, 3, None, 'Progressive SouthernRealms Building: Ivory'),
    111328: itemData(IC.useful, 1, 'Progressive teb_resource_gems', itemType.building, 3, None, "Progressive SouthernRealms Building: Gems"),
    111329: itemData(IC.useful, 1, 'Progressive teb_resource_dyes', itemType.building, 3, None, 'Progressive SouthernRealms Building: Dyes'),
    111330: itemData(IC.useful, 1, 'Progressive teb_resource_furs', itemType.building, 3, None, 'Progressive SouthernRealms Building: Furs'),
    111331: itemData(IC.useful, 1, 'Progressive teb_resource_marble', itemType.building, 3, None, 'Progressive SouthernRealms Building: Marble'),
    111332: itemData(IC.useful, 1, 'Progressive teb_resource_pottery', itemType.building, 3, None, 'Progressive SouthernRealms Building: Pottery'),
    111333: itemData(IC.useful, 1, 'Progressive teb_resource_wine', itemType.building, 3, None, 'Progressive SouthernRealms Building: Wine'),
}
