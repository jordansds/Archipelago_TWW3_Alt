...
buildings: dict[int, itemData] = {
    ...
    110496: itemData(IC.useful, 1, 'wh2_main_emp_resource_gemstones', itemType.building, 0, 'Progressive teb_resource_gems', 'SouthernRealms Building: Gem Mineshaft'),
    110497: itemData(IC.useful, 1, 'wh2_main_emp_resource_gemstones', itemType.building, 1, 'Progressive teb_resource_gems', 'SouthernRealms Building: Gem Mine'),
    110498: itemData(IC.useful, 1, 'wh2_main_emp_resource_gemstones', itemType.building, 2, 'Progressive teb_resource_gems', "SouthernRealms Building: Gemcutter's Workshop"),

    110499: itemData(IC.useful, 1, 'wh_main_emp_resource_dyes', itemType.building, 0, 'Progressive teb_resource_dyes', 'SouthernRealms Building: Cinnabar Mining Pit'),
    110500: itemData(IC.useful, 1, 'wh_main_emp_resource_dyes', itemType.building, 1, 'Progressive teb_resource_dyes', 'SouthernRealms Building: Cinnabar Mine'),
    110501: itemData(IC.useful, 1, 'wh_main_emp_resource_dyes', itemType.building, 2, 'Progressive teb_resource_dyes', 'SouthernRealms Building: Dyemaker'),

    110502: itemData(IC.useful, 1, 'wh_main_emp_resource_furs', itemType.building, 0, 'Progressive teb_resource_furs', 'SouthernRealms Building: Hunting Camp'),
    110503: itemData(IC.useful, 1, 'wh_main_emp_resource_furs', itemType.building, 1, 'Progressive teb_resource_furs', 'SouthernRealms Building: Hunting Lodge'),
    110504: itemData(IC.useful, 1, 'wh_main_emp_resource_furs', itemType.building, 2, 'Progressive teb_resource_furs', 'SouthernRealms Building: Tannery'),

    110505: itemData(IC.useful, 1, 'wh_main_emp_resource_marble', itemType.building, 0, 'Progressive teb_resource_marble', 'SouthernRealms Building: Stone Cutter'),
    110506: itemData(IC.useful, 1, 'wh_main_emp_resource_marble', itemType.building, 1, 'Progressive teb_resource_marble', 'SouthernRealms Building: Marble Quarry'),
    110507: itemData(IC.useful, 1, 'wh_main_emp_resource_marble', itemType.building, 2, 'Progressive teb_resource_marble', 'SouthernRealms Building: Mason'),

    110508: itemData(IC.useful, 1, 'wh_main_emp_resource_pottery', itemType.building, 0, 'Progressive teb_resource_pottery', 'SouthernRealms Building: Clay Pit'),
    110509: itemData(IC.useful, 1, 'wh_main_emp_resource_pottery', itemType.building, 1, 'Progressive teb_resource_pottery', 'SouthernRealms Building: Pottery Maker'),
    110510: itemData(IC.useful, 1, 'wh_main_emp_resource_pottery', itemType.building, 2, 'Progressive teb_resource_pottery', 'SouthernRealms Building: Kilns'),

    110514: itemData(IC.useful, 1, 'wh_main_emp_resource_wine', itemType.building, 0, 'Progressive teb_resource_wine', 'SouthernRealms Building: Orchards'),
    110515: itemData(IC.useful, 1, 'wh_main_emp_resource_wine', itemType.building, 1, 'Progressive teb_resource_wine', 'SouthernRealms Building: Vineyard'),
    110516: itemData(IC.useful, 1, 'wh_main_emp_resource_wine', itemType.building, 2, 'Progressive teb_resource_wine', 'SouthernRealms Building: Vinter'),
