...
progUnits: dict[int, itemData] = {
    103200: itemData(IC.useful, 2, "Progressive msl_inf", itemType.unit, 2, None, "Progressive Mousillon Unit: Infantry"),
    103201: itemData(IC.useful, 2, "Progressive msl_rng", itemType.unit, 2, None, "Progressive Mousillon Unit: Ranged"),
    103202: itemData(IC.useful, 3, "Progressive msl_cav", itemType.unit, 3, None, "Progressive Mousillon Unit: Cavalry"),
    103203: itemData(IC.useful, 1, "Progressive msl_art", itemType.unit, 1, None, "Progressive Mousillon Unit: Artillery"),
    103204: itemData(IC.useful, 4, "Progressive msl_veh", itemType.unit, 4, None, "Progressive Mousillon Unit: Chariot"),
    103205: itemData(IC.useful, 2, "Progressive msl_bst", itemType.unit, 2, None, "Progressive Mousillon Unit: Beast"),
    103206: itemData(IC.useful, 2, "Progressive msl_hro", itemType.unit, 2, None, "Progressive Mousillon Unit: Hero")
}

progBuildings: dict[int, itemData] = {
    103400: itemData(IC.useful, 2, 'Progressive msl_cemetery', itemType.building, 2, None, 'Progressive Mousillon Building: Cemetery'),
    103401: itemData(IC.useful, 2, 'Progressive msl_barracks', itemType.building, 2, None, 'Progressive Mousillon Building: Barracks'),
    103402: itemData(IC.useful, 2, 'Progressive msl_swamp', itemType.building, 2, None, 'Progressive Mousillon Building: Swamp'),
    103403: itemData(IC.useful, 3, 'Progressive msl_binding', itemType.building, 3, None, 'Progressive Mousillon Building: Binding'),
    103404: itemData(IC.useful, 2, 'Progressive msl_carpenter', itemType.building, 2, None, 'Progressive Mousillon Building: Carpenter'),
    103405: itemData(IC.useful, 3, 'Progressive msl_wraiths', itemType.building, 3, None, 'Progressive Mousillon Building: Wraiths'),
    103406: itemData(IC.useful, 2, 'Progressive msl_vampires', itemType.building, 2, None, "Progressive Mousillon Building: Vampires"),

    103407: itemData(IC.useful, 3, 'Progressive msl_walls', itemType.building, 3, None, 'Progressive Mousillon Building: Walls'),
    103408: itemData(IC.useful, 1, 'Progressive msl_battlefield', itemType.building, 1, None, 'Progressive Mousillon Building: Awakened Battlefield'),
    103409: itemData(IC.useful, 3, 'Progressive msl_foreign_slot_discovery', itemType.building, 3, None, 'Progressive Mousillon Building: Protection'),
    103410: itemData(IC.useful, 2, 'Progressive msl_garrison', itemType.building, 2, None, 'Progressive Mousillon Building: Garrison'),

    103411: itemData(IC.useful, 3, 'Progressive msl_swampaire', itemType.building, 3, None, 'Progressive Mousillon Building: Swampaire'),
    103412: itemData(IC.useful, 3, 'Progressive msl_ossuary', itemType.building, 3, None, 'Progressive Mousillon Building: Ossuary'),
    103413: itemData(IC.useful, 3, 'Progressive msl_farm', itemType.building, 3, None, 'Progressive Mousillon Building: Farms'),
    103414: itemData(IC.useful, 3, 'Progressive msl_balefire', itemType.building, 3, None, 'Progressive Mousillon Building: Witches'),
    103415: itemData(IC.useful, 3, 'Progressive msl_tavern', itemType.building, 3, None, 'Progressive Mousillon Building: Tavern'),
    103416: itemData(IC.useful, 2, 'Progressive msl_auction', itemType.building, 2, None, 'Progressive Mousillon Building: Trade'),
    103417: itemData(IC.useful, 3, 'Progressive msl_port', itemType.building, 3, None, 'Progressive Mousillon Building: Port'),

    103418: itemData(IC.useful, 3, 'Progressive msl_resource_animals', itemType.building, 3, None, 'Progressive Mousillon Building: Animals'),
    103419: itemData(IC.useful, 3, 'Progressive msl_resource_gemstones', itemType.building, 3, None, 'Progressive Mousillon Building: Gemstones'),
    103420: itemData(IC.useful, 3, 'Progressive msl_resource_medicine', itemType.building, 3, None, 'Progressive Mousillon Building: Medicine'),
    103421: itemData(IC.useful, 3, 'Progressive msl_resource_obsidian', itemType.building, 3, None, 'Progressive Mousillon Building: Obsidian'),
    103422: itemData(IC.useful, 3, 'Progressive msl_resource_spices', itemType.building, 3, None, 'Progressive Mousillon Building: Spices'),
    103423: itemData(IC.useful, 3, 'Progressive msl_resource_ivory', itemType.building, 3, None, 'Progressive Mousillon Building: Ivory'),
    103424: itemData(IC.useful, 3, 'Progressive msl_resource_dyes', itemType.building, 3, None, "Progressive Mousillon Building: Dyes"),
    103425: itemData(IC.useful, 3, 'Progressive msl_resource_furs', itemType.building, 3, None, "Progressive Mousillon Building: Furs"),
    103426: itemData(IC.useful, 3, 'Progressive msl_resource_gold', itemType.building, 3, None, 'Progressive Mousillon Building: Gold'),
    103427: itemData(IC.useful, 3, 'Progressive msl_resource_iron', itemType.building, 3, None, 'Progressive Mousillon Building: Iron'),
    103428: itemData(IC.useful, 3, 'Progressive msl_resource_marble', itemType.building, 3, None, "Progressive Mousillon Building: Marble"),
    103429: itemData(IC.useful, 3, 'Progressive msl_resource_pastures', itemType.building, 3, None, 'Progressive Mousillon Building: Pastures'),
    103430: itemData(IC.useful, 3, 'Progressive msl_resource_pottery', itemType.building, 3, None, 'Progressive Mousillon Building: Pottery'),
    103431: itemData(IC.useful, 3, 'Progressive msl_resource_salt', itemType.building, 3, None, 'Progressive Mousillon Building: Salt'),
    103432: itemData(IC.useful, 3, 'Progressive msl_resource_timber', itemType.building, 3, None, 'Progressive Mousillon Building: Timber'),
    103433: itemData(IC.useful, 3, 'Progressive msl_resource_wine', itemType.building, 3, None, 'Progressive Mousillon Building: Wine'),

    103434: itemData(IC.useful, 4, 'Progressive msl_settlement_major', itemType.building, 4, None, 'Progressive Building: Settlement Major'),
    103535: itemData(IC.useful, 2, 'Progressive msl_settlement_minor', itemType.building, 2, None, 'Progressive Building: Settlement Minor'),
}

progTechs: dict[int, itemData] = {
    103500: itemData(IC.useful, 2, "Progressive tech_msl_undead", itemType.tech, 2, None, "Progressive Mousillon Tech: Living Dead"),
    103501: itemData(IC.useful, 2, "Progressive tech_msl_living", itemType.tech, 2, None, "Progressive Mousillon Tech: Peasantry"),
    103502: itemData(IC.useful, 1, "Progressive tech_msl_knights", itemType.tech, 1, None, "Progressive Mousillon Tech: Knights of the Realm"),
    103503: itemData(IC.useful, 1, "Progressive tech_msl_swamp", itemType.tech, 1, None, "Progressive Mousillon Tech: Swamp Land"),
    103504: itemData(IC.useful, 2, "Progressive tech_msl_nobility", itemType.tech, 2, None, "Progressive Mousillon Tech: Nobility"),
}
